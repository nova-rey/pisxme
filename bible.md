...
manufacturer-confirmation gap for RTL9210B and does not alter production CAD.
...
2026-09-12 — Refreshed the private SXM2/J1 corpus against live source heads. The Benchoff repository remains `main`/HEAD at `3173b02c085218d66c4a2a9e5492853fb53ee097` with no advertised `v1.0.0` tag; the prior tag wording was corrected. The xiaoyu repository remains `main`/HEAD/`v1.0.0` at `c05541e1846b47f51d05a2149ff044d4d2eba727` but contains only README.md, so it is not contact-map corroboration. Added the current Amphenol 74221-101LF product-page metadata alongside drawing Rev W, corrected the brief-only GND count from 155 to the structured 170, and preserved all 31 NC/project-unknown plus K18/K19 auxiliary unknown contacts.
2026-09-12 — Librarian indexed the requested JLCPCB capabilities and 6-layer pages plus TI HD3SS6126 datasheet/product page for storage geometry. The public records establish JLC multilayer 0.09/0.09 mm 1-oz trace/space, 0.15/0.25 mm minimum via hole/diameter, 0.10 mm pad-to-track, 0.15 mm different-net SMD spacing, 0.20 mm via-to-track, and six-layer thickness/copper options; TI establishes U12 RUA WQFN 42, nominal 9.00 x 3.50 mm, 0.50 mm package pitch, 0.6 x 0.25 mm example lands, 2.05 x 7.55 mm thermal land, pad 43, and 0.8 mm maximum height. The retained U12 footprint's 0.40 mm pad-center pitch conflicts with TI's 0.50 mm package view; this remains an unresolved package-authority gate. No external PDF or page capture was copied into the Library or public repository.

2026-09-12 — Librarian indexed Amphenol/FCI 74221 Rev-W, GS-12-100 Rev R, and GS-20-033 Rev J manufacturer evidence for SXM2/J1 package identity and assembly/DFM constraints. Browser extraction was available, but direct NYX fetch returned HTTP 403 for all three PDFs; no local PDF hashes are claimed or copies retained. The records corroborate the 400-position 10x40 4-mm 74221 receptacle and application rules, not the reverse-engineered SXM2 electrical map.

2026-09-13 — Librarian indexed the Phase 24 component/firmware/programming/procurement evidence packet. Path A remains the selected TUSB9261 + JMS583 dual-mode implementation; RTL9210B remains isolated and unpromoted. TI E2E thread 538818 was added as manufacturer support guidance: SLLC416 requires FlashBurner header formatting before raw SPI programming and the firmware SATA polarity must match the board. JMS583 baseline mask-ROM operation is documented, while authorized JMS583 supply, TUSB gated-download/provisioning artifacts, dated procurement refresh, and the U12 0.40-vs-0.50 mm footprint conflict remain open. No CAD or public repository material was copied.
## 2026-09-13 — SXM2/J1 evidence refresh for Phase 24
...
- 2026-09-13: Reassessed the Phase 24 Branch-B power-envelope knowledge gap. Indexed Molex 0039300020, TI LM74700-Q1, TI LM74700 load-sharing, TI CSD19536KCS, and Littelfuse 0297015 manufacturer evidence plus the current PiSXMe design-envelope worksheets in `Library/briefs/power-envelope-authority-reassessment-20260913.md`. Field-by-field review classifies no indispensable field as D: connector/component facts are A, transparent worksheet arithmetic and component behavior support B, and harness policy, branch limits, fault response, environment, sharing tolerance, and load-step requirements are C decisions for Power Authority. No CAD changed; no signed requirement was asserted.
- 2026-09-13: Ingested the bounded Researcher evidence sack for the Branch-B envelope. The cached NVIDIA V100 datasheet supplies only the 300 W SXM2 maximum-power fact; the cached Molex authority note closes identity/mechanics only; the worker had no live search permission. Indexed the gap report and preserved the limitation without converting it into a D classification or a user blocker.

2026-09-13 — Librarian indexed Molex PS-5556-004-001 Rev B1 (ECM 851282, dated 2026-03-24, 17 pages) and the official 5556 terminal records for the V2.1 power-envelope candidate. The 16-AWG 2–3 circuit table is 8 A/circuit for phosphor bronze and 9 A/circuit for brass; V2.1's retained 8 A screen therefore selects the tin-plated phosphor-bronze 5556 family, 39000079 reel or 39000080 bag. The exact PDF bytes were not locally retained because direct NYX retrieval returned a different four-page product-detail response; no exact-PDF hash is claimed. Packaging, crimp, harness, and derating remain Package/Power Authority gates.
- 2026-09-13: Indexed MAX17527A, CSD19536KCS gate-drive limitation, Littelfuse fuse I²t/time-current data, and SMBJ18A TVS limits for P24-PROTECTION-DOSSIER. Returned exact external-FET, energy-coordination, and six-loop fault-aggregation gaps to Power Authority; no CAD or product requirement changed.

2026-09-14 — Librarian indexed the bounded P24 harness/installation thermal evidence. Molex PS-5556-001/004 establish 16-AWG phosphor-bronze 8 A at 2–3 circuits and a 30 C terminal-rise basis with required derating; Molex family records establish 5569/5557 temperature and geometry limits; Belden/Southwire wire records plus NIST copper tables provide resistance references and a temperature-correction method. No exact PiSXMe cable lengths, ambient/airflow class, six-header installation, or fabricated temperatures were invented; those remain Package/Power Authority fields. No restricted material was copied.

2026-09-14 — Librarian indexed the bounded exact reverse-protection nFET and fault-energy dossier. ST STL125N10LF8AG (AEC-Q101, 100 V, 5.8 mΩ max at 4.5 V/30 A, -55 to +175 C, avalanche/SOA evidence) is the strongest candidate; Infineon BSC096N10LS5 is a lower-margin comparator. Local TI LM74700-Q1 guidance and DMT6007LFG example corroborate the need for 4.5-V RDS(on) data but do not close the MAX17527A 4.45-V minimum or its different gate-drive contract. Fuse/TVS/harness facts were cross-linked; exact 4.45-V/temperature-bound RDS(on), PiSXMe transient waveform, SOA/I2t coordination, and harness installation remain Power Authority gates. No CAD or vendor PDF was copied.

2026-09-14 — Indexed the Researcher-returned Diodes DMT6007LFG and TI CSD18536KCS primary datasheets. Both provide explicit 4.5-V RDS(on) data and temperature/SOA evidence, but both are 60-V devices and leave the MAX17527A 4.45-V minimum and PiSXMe transient-energy qualification open. No MPN or CAD selection was made.

2026-09-17 — Indexed restricted JMicron/SmartCube JMS581DL design-in packet from Gmail thread 1a07744f40afaf44; preserved seven original attachment bytes and SHA-256 manifest in the private Library. Manufacturer evidence closes the prior JMS581 reference-evidence gap but does not supersede selected Path-A architecture; no public bytes or CAD changed.

2026-09-17 — Librarian indexed bounded authoritative 6 A limiter evidence for `P24-AUTHORITATIVE-6A-LIMITER-EVIDENCE`. Existing MAX17527A, TPS1663, LM5066H, LTC4218 and LTC4286 evidence fails the HPQ4 6.000–6.400 A full-tolerance window; MAX5977A is a current-sense/gate-drive building block, not a closed limiter. LTC4281/LTC4282 are the closest 2.9–33 V external-FET candidates with nominal 12 V drive and calibration/trim capability, but their published threshold ranges do not themselves guarantee the window or the <=57 mΩ hot path. No production MPN was promoted; Product/Power Authority must qualify a calibrated controller-plus-limiter assembly or request one further bounded search. No CAD or public repository material changed.

2026-09-17 — Librarian completed the one bounded `P24-6A-LIMITER-RESEARCH-ESCALATION` manufacturer search. Analog Devices ADM1175-1/-2 production records and Rev C datasheet were indexed as a new candidate: 3.15–16.5 V operation, 97–103 mV full-temperature current-limit threshold, external N-FET, timer/fast-trip behavior, and I2C readback. A 16.13 mΩ, 0.1%, 10 ppm/C screening shunt calculates 6.0037–6.3962 A and leaves approximately 40.843 mΩ of the 57 mΩ hot allocation, but exact shunt/FET/hot-path/reverse/SOA and production-test qualification remain open. No production architecture, CAD, or vendor bytes changed; bounded search stopped per package scope.

2026-09-17 — ADM1175 component-path qualification bounded

The bounded Power/Package/DFM review indexed primary ADI, Vishay, Ohmite, and Infineon evidence for exact shunt and external-FET candidates. The documented `WSK2512R0160BEA` candidate with ADM1175's untrimmed 97--103 mV threshold recalculates to 6.042710--6.458652 A and fails the 6.400 A ceiling; the earlier 16.13 mOhm / 10 ppm screen was hypothetical. `IRLS4030-7PPbF`, `BSC070N10LS5ATMA1`, and `BSC096N10LS5ATMA1` remain candidate FETs only because hot gate-drive, complete path, reverse/fault, thermal, and production-test contracts are open. No CAD or product-envelope change is authorized; the package remains on `authority:6A-limiter-qualification`.
2026-09-17 — Librarian indexed the bounded public SXM2/V100 carrier architecture sanity set for P24-POWER-ARCHITECTURE-PROVENANCE-AUDIT. Benchoff documents a simple one-SXM2 carrier with two 2x3 PCIe power headers; Tongde/OSHWHub describes 4/6-layer V100/P100/PG199 carrier variants but exposes no branch-current contract; LiuXinyu describes high-capacity external inputs with an internal connector-count conflict; AI-Cooling claims dual 6+2-pin and 300 W operation. No examined source publishes a six-loop precision-regulation requirement. Metadata/extracted facts only; no third-party CAD or images copied; authority selection remains with Product/Power Authority.
