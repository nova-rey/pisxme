...
2026-09-06: Spread selected-placement USB3 endpoint vias outside the U7 pad field; native DRC reached zero shorts and zero track crossings, but retained 259 opens and 42 clearance findings, so the probe remains unpromoted pending deliberate return-via and plane-clearance handling.
