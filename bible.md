...
2026-09-05: Ran the first matched native-pad Ethernet regeneration from PHASE24_CORRECTED_MACRO_PLACEMENT; all eight searches completed, but native DRC found real Ethernet shorts/crossings, so the candidate was preserved as ROUTE_IMPLEMENTATION_FAILURE without changing the selected macro-floorplan or validation gates.
