...
`phase24_erc_cluster_census.py` from `PHASE24_CURRENT_LIVE_erc.rpt`. It records
197 `endpoint_off_grid`, 232 `isolated_pin_label`, 30
`same_local_global_label`, and 24 `multiple_net_names` warnings. Findings are
