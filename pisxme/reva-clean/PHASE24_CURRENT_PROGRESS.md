...
The live canonical schematic is at **377 native ERC warnings / 0 errors**.
The current actionable ERC census is 197 `endpoint_off_grid`, 126
...
`PHASE24_CURRENT_LIVE_AFTER_LABEL_DEDUP_erc.rpt`. It records
197 `endpoint_off_grid`, 126 `isolated_pin_label`, 30
...
connector coordinates. That hypothesis was proven in disposable native
ERC/netlist comparison and promoted; see
`PHASE24_STORAGE_LABEL_DEDUP_PROMOTION_RECEIPT_20260912.md`.
