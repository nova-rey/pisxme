...
this environment, so no numeric availability claim is promoted.

| Source | Identity | Evidence | Risk |
|---|---|---|---|
| JLCPCB | RTL9210B-CG, C5143573, Realtek Semicon, QFN-68 | Current listing confirms identity, QFN-68, SMT, Economic/Standard PCBA, MSL 3, and PCBA-only storage | MEDIUM/HIGH: no reproducible quantity-1 price, stock depth, or lead time captured; not a standalone chip-shipping path |
