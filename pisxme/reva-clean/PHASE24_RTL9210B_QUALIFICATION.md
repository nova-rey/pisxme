...
composite parent; V1461 is rejected at native DRC with 19 violations / 14
...
evidence; they are not current TODOs unless named by those gates.
...
V1265 is rejected pad-60 evidence. The candidate required an undersized
...
OPEN.
V1267 is accepted incremental support evidence. U1.55 RTL_1V1 joins the
...
V1269 is accepted incremental support evidence. U1.40 RTL_1V1 joins the
live collector through a direct outward ordinary via with no new native DRC
errors; the saved-board endpoint and negative-control audit pass. Remaining
support is OPEN.
V1270/V1271 are accepted incremental support evidence. U1.36 and U1.16
join the live RTL_1V1 collector through direct outward ordinary vias with no
...
remain OPEN.
V1277 is accepted coupled rail evidence. U1.25 RTL_1V1 and U1.33 RTL_5V
