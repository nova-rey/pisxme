...
The current canonical census is **377 warnings / 0 errors** after the
promoted STORAGE duplicate-label repair and the
promoted regulator pin-stub, duplicate POWER_INPUT wire, and PWR_FLAG
...
ERC is **377 warnings / 0 errors**: 197 `endpoint_off_grid`, 126
