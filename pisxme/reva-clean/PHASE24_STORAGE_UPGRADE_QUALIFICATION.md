...
| NVMe alternatives | ASM2362, RTL9210B-CG, JMS586/JMS580, ASM2364/ASM2464 | Official pages where available plus corroborating ecosystem evidence; refreshed RTL9210B comparison in `PHASE24_RTL9210B_PATH_COMPARISON_20260909.md` | RTL9210B **PARALLEL CANDIDATE**; others remain non-selected | RTL9210B materially reduces bridge/switch count and has a corroborated shared-lane/PEDET implementation, but authorized application circuit, virgin provisioning, firmware rights, full route, and integrated validation remain open | HIGH | Continue Path B in isolation; Path A remains fallback. Do not promote without the narrow provisioning/application-circuit experiment |
