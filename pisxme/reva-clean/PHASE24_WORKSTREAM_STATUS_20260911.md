...
| Storage power/physical connectivity | Root Foreman / focused audit | OPEN | V94 strict source-tree audit reaches all nine J3 pads and all listed U12/U13/U14/R81 source pads, but native DRC finds nine real shorts from ordinary vias entering dense QFN fields (626/333). V93/V94 are rejected. Standard-rule via fanout is exhausted; next repair requires an authoritative local QFN breakout or storage-island regeneration with reserved source channels. |
