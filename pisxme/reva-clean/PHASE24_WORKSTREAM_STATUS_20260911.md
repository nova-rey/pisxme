...
| Storage power/physical connectivity | Root Foreman / focused audit | OPEN | V1562 remains the accepted focused J3 handoff: nine-contact audit and negative control pass, with no storage-rail shorts/crossings in its native DRC delta. V93/V94/V95 are rejected source-attachment experiments; V94 passed strict source reachability only by adding nine real QFN-via shorts, while V95 avoided those shorts but failed strict source ownership. The remaining gate is U12/U13 support-pad attachment under an authoritative local breakout. |
