...
| MagJack | CM5IO `TRJG0926HENL` reference | `authority-inventory/primary-docs/cm5io-component-authority.md` | Rev-A empirical risk; replacement required before release |
