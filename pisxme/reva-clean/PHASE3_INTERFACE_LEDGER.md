...
|---|---|---|---|
| CORE_CM5 | `CM5_PER0_P/N`, `CM5_PET0_P/N`, `CM5_REFCLK_P/N`, `CM5_PERST` | CM5 <-> V100 | Gen2 x1 only; Phase 1 PCIe donor and CM5 authority |
...
| V100_PCIE | `V100_PER0_P/N`, `V100_PET0_P/N`, `V100_REFCLK_P/N`, `V100_PERST` | high speed/control | SXM2 `74221-101LF`; lane 0 only; raw PET AC coupling |
