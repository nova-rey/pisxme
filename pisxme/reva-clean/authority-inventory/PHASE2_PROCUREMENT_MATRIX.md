...
| CM5IO Ethernet MagJack reference | `TRJG0926HENL` | JLC exact extended part `C9900198333`, but 0 in stock | No authoritative manufacturer or major-distributor exact record captured | JLC lists $0.0392 internal assembly price, minimum 444, full reel 500; consign-only | HIGH; `REV_A_EMPIRICAL_RISK`; Phase 3 needs documented compatible replacement or sample |
