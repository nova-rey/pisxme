...
def main():
    ...
    zones='\n'.join((rect(5,5,32,55,'POWER INPUT'),rect(5,60,32,110,'REGULATORS'),rect(5,115,70,175,'SERVICE / DEBUG'),rect(75,42.5,225,137.5,'V100 MODULE / TOP COOLING DATUM'),rect(240,20,295,70,'ETHERNET'),rect(235,80,295,125,'STORAGE BRIDGE'),rect(220,145,295,175,'M.2 2280 SERVICE')))
