...
MODULES = {
    ...
    "U4": {"vin": ("C14", "C15"), "vout": ("C16", "C17", "C19"),
           "xy": {"C14": (188, 103), "C15": (188, 105.25),
                  "C16": (188, 112), "C17": (188, 114), "C19": (188, 116)}},
}

U5_VIN = (("C23", (219, 112), ("1",), ((222.75, 103), (220.75, 103), (220.75, 111.5), (220.1, 112))),
          ("C24", (219, 115), ("5",), ((223.00, 105.25), (220.25, 105.25), (220.25, 114.5), (220.1, 115))),
          ("C25", (219, 118), ("5",), ((223.00, 105.25), (220.0, 105.25), (220.0, 117.5), (220.1, 118))))
