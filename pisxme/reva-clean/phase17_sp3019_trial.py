...
def main():
    ...
    bpaths = {
      "CM5_GBE_TD2_N":(((97.96,130.30),(97.96,136),(95,136),(95,132),(92,132),(92,130.95)),(97.96,136),(92,130.95),(90.95,130.95)),
      "CM5_GBE_TD2_P":(((97.96,130.70),(98.5,130.70),(98.5,137),(91,137),(91,129.05)),(98.5,137),(91,129.05),(90.95,129.05)),
      "CM5_GBE_TD0_N":(((101.04,130.30),(101.04,136),(105,136),(105,132),(108,132),(108,130.95)),(101.04,136),(108,130.95),(120.95,130.95)),
      "CM5_GBE_TD0_P":(((101.04,130.70),(102,130.70),(102,137),(110,137),(110,129.05)),(102,137),(110,129.05),(120.95,129.05)),}
    ...
    for name,(pts,src_via,esd_via,pad) in bpaths.items():
        ...
        via(b,src_via,name)
        for a,z in zip([src_via]+list(pts[2:]),list(pts[2:])+[esd_via]):
    ...
    out_paths = {
      ...
      "CM5_GBE_TD0_P":(((110,129.05),(110,84.06),(106.63,84.06)),pcbnew.B_Cu),
      "CM5_GBE_TD0_N":(((108,130.95),(106,130.95),(106,84.06),(104.09,84.06)),pcbnew.B_Cu),
    }
