...
def T(b, n, a, z, layer=pcbnew.F_Cu):
    ...
    t.SetWidth(pcbnew.FromMM(.15)); t.SetNet(n); b.Add(t)
def X(b, n, p):
...
def main():
    ...
    T(b, xi, (247,109.5), (250,109.5)); T(b, xi, (250,109.5), (250,111.15)); T(b, xi, (250,111.15), (253.9,111.15))
    ...
    T(b, xo, (248,109.5), (251,109.5)); T(b, xo, (251,109.5), (251,114.0)); T(b, xo, (251,114.0), (256.1,114.0));
    ...
    X(b, vs, (246,108)); T(b, vs, (246,108), (252,108), pcbnew.B_Cu); T(b, vs, (252,108), (252,116), pcbnew.B_Cu)
