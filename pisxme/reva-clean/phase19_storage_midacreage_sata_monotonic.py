"""Monotonic mid-acreage SATA pair launches with no shared-lane turns."""
from pathlib import Path
import pcbnew
ROOT=Path(__file__).resolve().parent
BASE=ROOT/'ACREAGE_PHASE18_USB3_LOCAL.kicad_pcb';OUT=ROOT/'ACREAGE_PHASE19_STORAGE_MIDACREAGE_SATA_MONOTONIC.kicad_pcb';W=pcbnew.FromMM(.15)
...
def main():
 ...
 # TX remains an ordered F.Cu pair from the top row to the right connector column.
 for name,upn,jpn,way in (
  ('BRIDGE_SATA_TX_P','57','1',((130,130),(139.72,134.25))),
  ('BRIDGE_SATA_TX_N','56','2',((132,131),(147.28,134.0)))):
  n=b.FindNet('/STORAGE/'+name);tr(b,n,up[upn],way[0],pcbnew.F_Cu);tr(b,n,way[0],way[1],pcbnew.F_Cu);tr(b,n,way[1],jp[jpn],pcbnew.F_Cu)
 # RX uses B.Cu trunks and only connector dogbones on F.Cu.
 for name,upn,jpn,start,lane,final in (
  ('BRIDGE_SATA_RX_P','60','3',(119,130),(136,130),(136,133.75)),
  ('BRIDGE_SATA_RX_N','59','4',(119.5,131),(144,131),(144,133.5))):
