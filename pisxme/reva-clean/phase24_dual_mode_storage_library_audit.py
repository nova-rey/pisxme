...
def main():
    ...
    checks.append(('JMS583 has 64 signal pads plus EP',len(p)==65 and p[-1][0]=='65'))
    checks.append(('JMS583 numbering is 1..64 plus EP 65',
                   [x[0] for x in p]==[str(i) for i in range(1,65)]+['65']))
