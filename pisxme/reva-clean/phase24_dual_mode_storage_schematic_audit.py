...
REQUIRED={
 'U8':('JMS583-QHFA3A','JMS583_QFN64_8x8',('USB_DM','USB_DP','USB_TXP1','USB_RXP1','PCIE_RXN0','PCIE_RXP0','PCIE_TXN0','PCIE_TXP0','REFCLK_N','REFCLK_P','PCIE_RESET_N','PCIE_CLKREQ_N')),
 'U9':('HD3SS6126RUAR','HD3SS6126_RUA0042A',('USB_SEL','USB_OE_N','CM5_SSTXP','CM5_SSRXP','TUSB_SSTXP','TUSB_SSRXP','JMS_SSTXP','JMS_SSRXP')),
 'U10':('HD3SS3412RUAR','HD3SS3412_RUA0042A',('STORAGE_SEL','SOCKET_P0_TX','SOCKET_P0_RX','TUSB_SATA_TXP','TUSB_SATA_RXP','JMS_PCIE_TXP0','JMS_PCIE_RXP0')),
...
def main():
    ...
    for ref,(mpn,fp,nets) in REQUIRED.items():
        ...
        for net in nets:
            if f'(label "{net}"' not in t: failures.append(ref+' missing label '+net)
