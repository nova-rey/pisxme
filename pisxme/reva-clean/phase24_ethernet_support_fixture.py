...
def main():
    ...
    for i, net in enumerate(("ETH_CT1", "ETH_CT2", "ETH_CT3", "ETH_CT4"), 1):
        x = 100 + i * 8
        parts.append(passive("C", f"C{47+i}", "22nF 100V", "PROVISIONAL_NOT_PROCUREMENT_AUTHORITY", "PiSXMeRevAClean:C_0402_1005Metric", x, 50, net, f"ETH_CT_BRANCH_{i}"))
        parts.append(passive("R", f"R{25+i}", "75R", "PROVISIONAL_NOT_PROCUREMENT_AUTHORITY", "PiSXMeRevAClean:R_0402_1005Metric", x, 60, f"ETH_CT_BRANCH_{i}", "ETH_CT_COMMON"))
    parts.append(passive("C", "C52", "1nF 2kV", "PROVISIONAL_NOT_PROCUREMENT_AUTHORITY", "PiSXMeRevAClean:C_1206_3216Metric", 108, 75, "ETH_CT_COMMON", "GBE_SHIELD", False, True))
    parts.append(passive("R", "R30", "470R", "PROVISIONAL_NOT_PROCUREMENT_AUTHORITY", "PiSXMeRevAClean:R_0402_1005Metric", 145, 50, "CM5_ETH_LED2", "GBE_LED_Y_K", True, False))
    parts.append(passive("R", "R31", "470R", "PROVISIONAL_NOT_PROCUREMENT_AUTHORITY", "PiSXMeRevAClean:R_0402_1005Metric", 155, 50, "CM5_ETH_LED3", "GBE_LED_G_K", True, False))
