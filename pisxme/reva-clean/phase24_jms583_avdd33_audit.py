...
PCB=R/os.environ.get('PISXME_AVDD33_AUDIT_PCB','PHASE24_JMS583_AVDD33_PROBE.kicad_pcb'); NEG=R/os.environ.get('PISXME_AVDD33_AUDIT_NEG','PHASE24_JMS583_AVDD33_NEGATIVE.kicad_pcb')
def connected(b):
