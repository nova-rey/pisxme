...
import os,pcbnew
R=Path(__file__).resolve().parent;PCB=Path(os.environ.get('PISXME_LXO_AUDIT_PCB',R/'PHASE24_JMS583_LXO_PROBE.kicad_pcb'));NEG=Path(os.environ.get('PISXME_LXO_AUDIT_NEG',R/'PHASE24_JMS583_LXO_NEGATIVE.kicad_pcb'))
def connected(b):
