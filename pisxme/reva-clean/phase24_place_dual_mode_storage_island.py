...
MAPS={
 ...
 'SOT-23-5.kicad_mod':('U14',{2:'M2_PEDET',3:'POWER_GND',4:'STORAGE_SEL',5:'STORAGE_3V3'})}
...
def main():
    ...
    for fname,(ref,nets) in MAPS.items():
        if ref=='J3': continue
        additions.append(pcb_footprint(LIB/fname,ref,{'U11':150,'U12':165,'U13':180,'U14':210}[ref],150,nets))
