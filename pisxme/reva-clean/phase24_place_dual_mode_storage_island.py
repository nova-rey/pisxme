...
SUPPORT_PCB.update({
 'C30':{1:'TUSB_SATA_TXP',2:'BRIDGE_SATA_TX_P'},
 'C31':{1:'TUSB_SATA_TXN',2:'BRIDGE_SATA_TX_N'},
 'C32':{1:'TUSB_SATA_RXP',2:'BRIDGE_SATA_RX_P'},
 'C33':{1:'TUSB_SATA_RXN',2:'BRIDGE_SATA_RX_N'},
