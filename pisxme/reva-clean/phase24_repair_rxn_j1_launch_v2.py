"""Disposable RX_N J1 launch repair using the existing clear RX_P via column."""
from pathlib import Path
import pcbnew
R=Path(__file__).resolve().parent
BASE=R/'PHASE24_DUAL_MODE_STORAGE_FULL7_VBUS_measured_gap.kicad_pcb'
OUT=R/'PHASE24_DUAL_MODE_STORAGE_FULL7_VBUS_RXN_REPAIR_V2.kicad_pcb'
...
vi(b,n,(147,88)); tr(b,n,B,(73,88),(147,88)); tr(b,n,B,(147,88),(147,137.8)); tr(b,n,B,(147,137.8),(145,137.8)); vi(b,n,(145,137.8)); tr(b,n,F,(145,137.8),(153.5,137.8))
