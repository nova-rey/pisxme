"""Disposable VBUS-sense route with west/outboard resistor-side via."""
from pathlib import Path
import pcbnew
R=Path(__file__).resolve().parent; BASE=R/'PHASE24_DUAL_MODE_STORAGE_FULL7_VBUS_RXN_REPAIR_V3.kicad_pcb'; OUT=R/'PHASE24_DUAL_MODE_STORAGE_FULL7_VBUS_RXN_REPAIR_V11.kicad_pcb'; F,B=pcbnew.F_Cu,pcbnew.B_Cu
