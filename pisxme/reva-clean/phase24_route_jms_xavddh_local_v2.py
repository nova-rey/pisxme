"""Corrected west-side JMS_XAVDDH escape from the REXT base."""
from pathlib import Path
import pcbnew
R=Path(__file__).resolve().parent;BASE=R/'PHASE24_STORAGE_MKEY_USB3_REXT_LOCAL_20260912.kicad_pcb';OUT=R/'PHASE24_STORAGE_MKEY_USB3_XAVDDH_LOCAL_V2_20260912.kicad_pcb'
...
src=xy(u.FindPadByNumber('52'));dst=xy(c.FindPadByNumber('1'))
f=[src,(137.0,src[1]),(137.0,130.0)]
for a,z in zip(f,f[1:]):tr(b,n,a,z,pcbnew.F_Cu)
via(b,n,f[-1]); q=(149.0,118.0);tr(b,n,f[-1],q,pcbnew.B_Cu);via(b,n,q);tr(b,n,q,dst,pcbnew.F_Cu)
