#!/usr/bin/env python3
"""Path-B disposable: jog U1 RTL_3V3 pad-52 west of the GND transition."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_5V_PAD17_V3.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_3V3_PAD52_V2.kicad_pcb'
...
def main():
 ...
 seg(b,n,(76.05,58.8),(74.2,58.8)); seg(b,n,(74.2,58.8),(74.2,48.0))
