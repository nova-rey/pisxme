#!/usr/bin/env python3
"""Path-B V12: move PEDET upper return to y=42.5, clear of via and edge."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_CONTROL_SUPPORT_LOCAL_V6.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_CONTROL_SUPPORT_LOCAL_V12.kicad_pcb'
...
def main():
    ...
    path(b,n,[(68,43),(68,42.5),(144,42.5),(144,61.5),(140.75,61.5),(140.75,62.725)],F)
