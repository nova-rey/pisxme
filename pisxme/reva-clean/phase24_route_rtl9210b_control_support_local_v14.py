#!/usr/bin/env python3
"""Path-B V14: remove the redundant PEDET B.Cu via and clear GND via."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_CONTROL_SUPPORT_LOCAL_V6.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_CONTROL_SUPPORT_LOCAL_V14.kicad_pcb'
...
def main():
    ...
    path(b,n,[(68,48),(71,48)],F); path(b,n,[(68,48),(68,43)],B)
    path(b,n,[(68,43),(68,43.0),(144,43.0)],B); via(b,n,(144,43.0))
    path(b,n,[(144,43.0),(144,61.5),(140.75,61.5),(140.75,62.725)],F)
