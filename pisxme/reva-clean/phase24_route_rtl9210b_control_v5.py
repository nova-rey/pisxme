#!/usr/bin/env python3
"""V5: PEDET on F.Cu; CLKREQ_N on B.Cu with separated pull-up branches."""
from pathlib import Path
import re
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_RESET_PERST_V2.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_CONTROL_V5.kicad_pcb'
def main():
 text=BASE.read_text()
 ...
 r=[]
 r += [s('PEDET',(79.6,65.95),(79.6,67.0),'F.Cu'),s('PEDET',(79.6,67.0),(80.5,67.0),'F.Cu'),v('PEDET',(80.5,67.0)),s('PEDET',(80.5,67.0),(80.5,41.0),'B.Cu'),v('PEDET',(80.5,41.0)),s('PEDET',(80.5,41.0),(140.75,41.0),'F.Cu'),s('PEDET',(140.75,41.0),(140.75,62.725),'F.Cu'),s('PEDET',(115.0,41.0),(115.0,52.0),'F.Cu'),s('PEDET',(115.0,52.0),(109.4,52.0),'F.Cu'),s('PEDET',(109.4,52.0),(109.4,51.0),'F.Cu')]
