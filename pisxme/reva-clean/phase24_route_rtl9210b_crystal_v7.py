#!/usr/bin/env python3
"""Path-B disposable: corrected 1V1 lower collector and XTAL_OUT return."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_5V_PAD17_V3.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_CRYSTAL_V7.kicad_pcb'
...
def main():
 ...
 seg(b,n1,B,(74.0,60.2),(74.5,62.0)); seg(b,n1,B,(74.5,62.0),(74.5,67.5))
 ...
 add(b,'XTAL_OUT',F,[(72.8,60.6),(74.8,60.6),(74.8,59.6),(76.05,59.6)])
