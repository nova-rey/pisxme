#!/usr/bin/env python3
"""SPI V4 removes unnecessary F-only vias and widens U1 fanout clearance."""
from pathlib import Path
import re
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_SUPPORT_LOCAL_V2.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_SPI_V4.kicad_pcb'
def main():
    ...
    r=[]
    lanes=[('SPICS',(83.95,62.8),(85.0,62.8),(85.0,61.0),(86.0,61.0),(90.8,48.0)),
    ...
    n='SPICLK'; src=(83.95,64.8); a=(85.0,64.8); b=(85.0,68.0); dv=(96.8,69.0)
    r += [s(n,src,a),s(n,a,b),s(n,b,dv),s(n,dv,(dv[0],58.0))]
    n='SPISI'; src=(83.95,65.2); a=(84.5,65.2); b=(84.5,70.0); dv=(95.6,46.0)
    r += [s(n,src,a),s(n,a,b),s(n,b,(95.6,70.0)),s(n,(95.6,70.0),dv),s(n,dv,(dv[0],58.0))]
