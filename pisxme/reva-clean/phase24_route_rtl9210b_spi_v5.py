#!/usr/bin/env python3
"""SPI V5 routes SPICLK around the SPISI vertical return corridor."""
from pathlib import Path
import re
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_SUPPORT_LOCAL_V2.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_SPI_V5.kicad_pcb'
def main():
    ...
    n='SPICLK'; r += [s(n,(83.95,64.8),(85.0,64.8)),s(n,(85.0,64.8),(85.0,68.0)),s(n,(85.0,68.0),(97.5,68.0)),s(n,(97.5,68.0),(97.5,69.0)),s(n,(97.5,69.0),(96.8,69.0)),s(n,(96.8,69.0),(96.8,58.0))]
    n='SPISI'; r += [s(n,(83.95,65.2),(84.5,65.2)),s(n,(84.5,65.2),(84.5,70.0)),s(n,(84.5,70.0),(95.6,70.0)),s(n,(95.6,70.0),(95.6,46.0)),s(n,(95.6,46.0),(95.6,58.0))]
