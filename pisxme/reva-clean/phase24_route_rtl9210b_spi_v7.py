#!/usr/bin/env python3
"""SPI V7 moves SPICLK to a separated B.Cu corridor after source fanout."""
from pathlib import Path
import re
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_SUPPORT_LOCAL_V2.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_SPI_V7.kicad_pcb'
def main():
    ...
    n='SPICLK'; src=(83.95,64.8); esc=(89.0,64.8); sv=(89.0,52.0); dv=(96.8,55.5)
    r += [s(n,src,esc),v(n,esc),s(n,esc,sv,'B.Cu'),s(n,sv,(100.0,52.0),'B.Cu'),s(n,(100.0,52.0),(100.0,55.5),'B.Cu'),s(n,(100.0,55.5),dv,'B.Cu'),v(n,dv),s(n,dv,(96.8,58.0))]
