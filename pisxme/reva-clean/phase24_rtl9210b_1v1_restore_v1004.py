"""V1004: restore the V930 RTL_1V1 fanout onto the V1003 rail basis."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; BASE=H/'PHASE24_RTL9210B_5V_RESTORE_V1003.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_1V1_RESTORE_V1004.kicad_pcb'; F=pcbnew.F_Cu; L=pcbnew.In2_Cu; W=pcbnew.FromMM(.20)
...
esc=[([(101.95,67.2),(102.8,67.2)],(102.8,67.2)), ([(94.05,67.2),(92.5,67.2)],(92.5,67.2)), ([(94.05,68.8),(92.5,68.8)],(92.5,68.8)), ([(94.05,72.8),(92.5,72.8)],(92.5,72.8)), ([(96,73.95),(96,75.5)],(96,75.5)), ([(98,73.95),(98,75.5)],(98,75.5)), ([(99.2,73.95),(99.2,77.0),(101.5,77.0)],(101.5,77.0))]
for pts,z in esc:
