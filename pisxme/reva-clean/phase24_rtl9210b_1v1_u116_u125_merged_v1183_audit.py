...
G=[('U1','16'),('U1','25'),('U1','36'),('U1','40'),('U1','50'),('U1','55'),('U1','60'),('U1','63'),('C4','1')]
...
print('PASS V1183 native all eight QFN 1V1 pads-to-C4.1 connectivity; eight complete source-trace negative controls PASS')
