"""V1162: west source via and outboard 1V1 collector."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_XTAL_STAGGERED_V1160.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_1V1_U155_TO_C4_V1162.kicad_pcb'
...
tr(b,n,F,[(94.05,68.0),(93.4,68.0)]); via(b,n,(93.4,68.0))
tr(b,n,B,[(93.4,68.0),(93.4,82.0),(121.0,82.0),(121.0,51.0)]); via(b,n,(121.0,51.0)); tr(b,n,F,[(121.0,51.0),(123.4,51.0)])
