"""Native V361 refilled-zone audit and trace-removal negative control."""
import pcbnew
from pathlib import Path
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_RTL1V1_COALLOCATE_V361.kicad_pcb'
...
def main():
 ...
 print('PASS V361 native RTL_1V1 refilled zone; trace-removal negative control PASS')
