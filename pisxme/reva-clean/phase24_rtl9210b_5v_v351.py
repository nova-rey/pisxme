"""V351: use a B.Cu handoff for RTL_5V around the In2 RTL_3V3 tree."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; BASE=H/'PHASE24_RTL9210B_RTL3V3_ROUTE_V342.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_RTL5V_ROUTE_V351.kicad_pcb'
...
def main():
 ...
 for a,z in [((103.5,64.8),(108,64.8)),((108,64.8),(108,57)),((108,57),(98.5,57))]: s(b,n,B,a,z)
