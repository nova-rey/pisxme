"""V1145: add the retained V1119 XTAL_IN primitive to accepted V1144."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_XTALOUT_VIA_CLEARANCE_V1144.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_XTALIN_WITH_XTALOUT_V1145.kicad_pcb'
...
tr(b,n,B,[(91.5,68.6),(91.5,75.0),(85.5,75.0),(85.5,62.0)]);via(b,n,(85.5,62.0))
tr(b,n,F,[(85.5,62.0),c,y])
