"""V431: final upper CLKREQ dogleg clearance probe."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_PEDET_NATIVE_ESCAPE_V418.kicad_pcb'; out=H/'PHASE24_RTL9210B_CLKREQ_QFN_CLEARANCE_V431.kicad_pcb'
...
seg(b,n,F,(104.4,58.05),(104.4,57.1)); seg(b,n,F,(104.4,57.1),(105.0,57.1)); seg(b,n,F,(105.0,57.1),(105.0,55.5)); via(b,n,(105.0,55.5))
