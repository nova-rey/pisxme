"""V218: CLKREQ early layer transition clears the PEDET F.Cu launch."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_PEDET_R2_U18_J1_69_V215.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_CLKREQ_U113_J1_52_V218.kicad_pcb'
...
def main():
    ...
    add(b,n,pcbnew.F_Cu,(101.95,60.4),(102.4,60.4));via(b,n,102.4,60.4)
    add(b,n,pcbnew.B_Cu,(102.4,60.4),(102.4,68.4));add(b,n,pcbnew.B_Cu,(102.4,68.4),(137.5,68.4));via(b,n,137.5,68.4)
