"""V229: layer-separated complete CLKREQ around PEDET/PERST/RSET."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_QFN_SIDEBAND_SPISO3_PERST_V227.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_CLKREQ_R3_U113_J1_52_V229.kicad_pcb'
...
def main():
    ...
    add(b,n,B,(102.4,61.0),(102.4,64.0));add(b,n,B,(102.4,64.0),(103.5,64.0));via(b,n,103.5,64.0)
    add(b,n,F,(103.5,64.0),(103.5,65.0));add(b,n,F,(103.5,65.0),(137.5,65.0));add(b,n,F,(137.5,65.0),(137.5,70.28));add(b,n,F,(137.5,70.28),(136.5,70.28))
    add(b,n,F,(92.0,48.0),(92.0,42.0));via(b,n,92.0,42.0)
    add(b,n,B,(92.0,42.0),(80.0,42.0));add(b,n,B,(80.0,42.0),(80.0,64.0));add(b,n,B,(80.0,64.0),(102.4,64.0))
