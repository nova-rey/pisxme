"""V303: CLKREQ lower corridor with east R3 and U1 launches."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_PEDET_ROUTE_V300.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_CLKREQ_ROUTE_V303.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(93.4,53),(95,53));tr(b,n,F,(95,53),(95,46));via(b,n,(95,46));tr(b,n,B,(95,46),(75,46));tr(b,n,B,(75,46),(75,74));tr(b,n,B,(75,74),(103.2,74));via(b,n,(103.2,74));tr(b,n,F,(103.2,74),(105.5,74));via(b,n,(105.5,74));tr(b,n,B,(105.5,74),(137.5,74));via(b,n,(137.5,74));tr(b,n,F,(137.5,74),(136.5,70.275));tr(b,n,F,(101.95,60.4),(103.2,61.5));via(b,n,(103.2,61.5));tr(b,n,B,(103.2,61.5),(103.2,74))
