"""V321: disposable coherent U1/support reorientation placement probe."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_M2_NORMALIZED_V320.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_COHERENT_REORIENT_V321.kicad_pcb'
...
def main():
    ...
    for ref in ['U1','U2','Y1','C1','C2','R1','R2','R3','C3','C4','C5']:
        ...
        if f:
            if ref=='U1': f.SetPosition(pcbnew.VECTOR2I_MM(112,62)); f.SetOrientationDegrees(0)
