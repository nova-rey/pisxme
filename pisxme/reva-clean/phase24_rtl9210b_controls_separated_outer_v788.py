"""V788: outer return for CLKREQ_N avoids the PEDET and 3V3 shelves."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_CONTROL_ABOVE_SPI_PLACEMENT_V777.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_CONTROL_SEPARATED_OUTER_V788.kicad_pcb'
...
n=b.FindNet('CLKREQ_N'); T(b,n,F,(101.95,68.4),(105.25,68.4)); V(b,n,(105.25,68.4)); T(b,n,B,(105.25,68.4),(105.25,52)); T(b,n,B,(105.25,52),(110.2,52)); V(b,n,(110.2,52)); T(b,n,F,(110.2,52),(113,52)); T(b,n,F,(113,52),(113,65)); T(b,n,F,(113,65),(111,65)); T(b,n,F,(111,65),(111,62))
