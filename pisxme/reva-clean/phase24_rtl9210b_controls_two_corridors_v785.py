"""V785: two separated B.Cu control corridors with 0.20 mm tracks."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_CONTROL_ABOVE_SPI_PLACEMENT_V777.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_CONTROL_TWO_CORRIDORS_V785.kicad_pcb'
...
n=b.FindNet('PEDET'); T(b,n,F,(101.95,70.4),(102.8,70.4)); V(b,n,(102.8,70.4)); T(b,n,B,(102.8,70.4),(102.8,58)); T(b,n,B,(102.8,58),(109.4,58)); V(b,n,(109.4,58)); T(b,n,F,(109.4,58),(110,58))
...
n=b.FindNet('RTL_3V3'); T(b,n,F,(111.2,58),(112.2,58)); T(b,n,F,(112.2,58),(112.2,62)); T(b,n,F,(112.2,62),(112.2,62))
