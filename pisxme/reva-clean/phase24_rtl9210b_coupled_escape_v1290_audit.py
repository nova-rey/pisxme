"""V1290 native coupled endpoints and saved-board negative control."""
from pathlib import Path
import pcbnew
P=Path(__file__).resolve().parent/'PHASE24_RTL9210B_COUPLED_ESCAPE_V1290.kicad_pcb'
...
print('PASS V1290 native coupled RTL_1V1/SPICS endpoints and saved-board negative control')
