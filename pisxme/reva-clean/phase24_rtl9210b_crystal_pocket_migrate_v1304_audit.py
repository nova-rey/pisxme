"""V1304 saved-board crystal/RSET endpoints and negative controls."""
from pathlib import Path
import pcbnew
P=Path(__file__).resolve().parent/'PHASE24_RTL9210B_CRYSTAL_POCKET_MIGRATE_V1304.kicad_pcb'
G={'RSET':(('U1','51'),('R1','1')),'XTAL_IN':(('U1','53'),('Y1','1'),('C1','1')),'XTAL_OUT':(('U1','54'),('Y1','2'),('C2','1'))}
...
for net,e in G.items():
 assert all(ei in p and p[ei].GetNetname()==net for ei in e); assert all(ei in (reach(b,p[e[0]])|{e[0]}) for ei in e); print(net,'endpoint: PASS')
