"""V1477: route the RTL9210B exposed-pad GND around the QFN west perimeter."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_U163_RXN_REHOME_V1469.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_GND_LEFT_PERIMETER_V1477.kicad_pcb'
...
# Exit from the exposed pad's west edge, below the top-row support pads, then
# use B.Cu around the west perimeter to the already-authoritative GND via.
seg('GND',(95.60,67.60),(92.60,67.60),F)
via('GND',(92.60,67.60)); seg('GND',(92.60,67.60),(92.60,62.50),B)
seg('GND',(92.60,62.50),(94.00,62.00),B)
