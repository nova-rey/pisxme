"""V1484: smaller ordinary through-via in the verified top launch pocket."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; BASE=H/'PHASE24_RTL9210B_U163_RXN_REHOME_V1469.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_GND_TOP_LAUNCH_V1484.kicad_pcb'; b=pcbnew.LoadBoard(str(BASE))
...
tr((100.4,67.6),(100.9,67.6)); tr((100.9,67.6),(101.2,68.2))
v=pcbnew.PCB_VIA(b); v.SetPosition(V(101.2,68.2)); v.SetWidth(pcbnew.FromMM(.40)); v.SetDrill(pcbnew.FromMM(.15)); v.SetLayerPair(pcbnew.F_Cu,pcbnew.B_Cu); v.SetNet(n); v.SetNetCode(n.GetNetCode()); b.Add(v)
