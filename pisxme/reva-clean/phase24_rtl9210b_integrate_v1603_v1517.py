...
F,B=pcbnew.F_Cu,pcbnew.B_Cu; W=pcbnew.FromMM(.20); FW=pcbnew.FromMM(.15); P=lambda x,y:pcbnew.VECTOR2I_MM(float(x),float(y))
...
def fine_seg(n,a,z,l):
    if a==z:return
    q=pcbnew.PCB_TRACK(b); q.SetStart(P(*a)); q.SetEnd(P(*z)); q.SetLayer(l); q.SetWidth(FW); q.SetNet(n); q.SetNetCode(n.GetNetCode()); b.Add(q)
def via(n,x,y):
...
for name in N:
    ...
    if name=='REFCLK_P': fine_seg(net,(ax,ay),(93,70.4),F); seg(net,(93,70.4),(90,70.4),F); seg(net,(90,70.4),(90,68),F); seg(net,(90,68),(85,68),F)
    elif name=='REFCLK_N': fine_seg(net,(ax,ay),(93,70.8),F); seg(net,(93,70.8),(89,70.8),F); seg(net,(89,70.8),(89,69),F); seg(net,(89,69),(85,69),F)
    elif name=='LANE0_RXP': fine_seg(net,(ax,ay),(93,71.6),F); seg(net,(93,71.6),(88,71.6),F); seg(net,(88,71.6),(88,70),F); seg(net,(88,70),(85,70),F)
    elif name=='LANE0_RXN': fine_seg(net,(ax,ay),(93,72),F); seg(net,(93,72),(87,72),F); seg(net,(87,72),(87,71),F); seg(net,(87,71),(85,71),F)
    elif name=='LANE0_TXN':
        fine_seg(net,(ax,ay),(93,72.8),F); seg(net,(93,72.8),(92.5,72.8),F); seg(net,(92.5,72.8),(92.5,74),F); via(net,92.5,74); seg(net,(92.5,74),(86,74),B); via(net,86,74); seg(net,(86,74),(86,72),F); seg(net,(86,72),(85,72),F)
    else:
        fine_seg(net,(ax,ay),(93,73.2),F); seg(net,(93,73.2),(93.5,73.2),F); seg(net,(93.5,73.2),(93.5,75),F); via(net,93.5,75); seg(net,(93.5,75),(85,75),B); via(net,85,75); seg(net,(85,75),(85,73),F)
