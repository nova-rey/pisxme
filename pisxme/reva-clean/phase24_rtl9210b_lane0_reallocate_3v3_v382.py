"""V382: V381 with the 3V3 drop moved below the RSET/XTAL channels."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SUPPORT_XTALOUT_DIRECT_V372.kicad_pcb'; SRC=H/'PHASE24_RTL9210B_LANE0_ROUTE_V328.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_LANE0_REALLOCATE_3V3_V382.kicad_pcb'
...
def main():
 ...
 n=b.FindNet('RTL_3V3'); seg(b,n,F,(109.95,65.2),(107,65.2)); seg(b,n,F,(107,65.2),(107,68.5)); via(b,n,(107,68.5)); seg(b,n,B,(107,68.5),(104.4,68.5))
