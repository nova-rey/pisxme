"""V385: V384 with the 3V3 transition moved clear of the RXP via."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SUPPORT_XTALOUT_DIRECT_V372.kicad_pcb'; SRC=H/'PHASE24_RTL9210B_LANE0_ROUTE_V328.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_LANE0_REALLOCATE_RSET_3V3_V385.kicad_pcb'
...
def main():
 ...
 n=b.FindNet('RTL_3V3'); seg(b,n,F,(109.95,65.2),(110.0,65.2)); seg(b,n,F,(110.0,65.2),(110.0,66.8)); via(b,n,(110.0,66.8)); seg(b,n,B,(110.0,66.8),(112,66.8)); seg(b,n,B,(112,66.8),(112,65.2)); via(b,n,(112,65.2)); seg(b,n,pcbnew.In2_Cu,(112,65.2),(104.4,68.5))
