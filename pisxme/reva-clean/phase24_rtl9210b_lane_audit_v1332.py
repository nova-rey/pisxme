"""Native V1332 lane connectivity audit with four negative controls."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
PCB=H/'PHASE24_RTL9210B_V1058_SUPPORT_LANE_ORIGINAL_J1_V1332.kicad_pcb'
...
for net,u,j,sv,up in LANES:
    t=pcbnew.LoadBoard(str(PCB)); pt=pads(t); source_via(t,net,sv)
    removed=False
...
print('PASS V1332 native four-lane endpoints and four source-removal negative controls')
