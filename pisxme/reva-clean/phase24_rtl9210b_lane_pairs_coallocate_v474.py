"""V474: lane-pair coallocation with TX rows beyond PEDET/CLKREQ."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_ROTATED_SOURCE_PLANAR_V462.kicad_pcb'; out=H/'PHASE24_RTL9210B_LANE_PAIRS_COALLOCATE_V474.kicad_pcb'
...
for name,q,mid,row,side,entry,dst in [('LANE0_TXN',(115,67.4),(120,67.4),(120,80),(142,80),(134.75,59.2),(135.25,62.725)),('LANE0_TXP',(116,66.5),(121,66.5),(121,79),(121,57.5),(135.75,57.5),(135.75,62.725))]:
