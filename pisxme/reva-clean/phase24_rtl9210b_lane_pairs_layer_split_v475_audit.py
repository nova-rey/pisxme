"""Native saved-board audit for V475's four MDI pair paths."""
from pathlib import Path
import pcbnew
ROOT=Path(__file__).resolve().parent; PCB=ROOT/'PHASE24_RTL9210B_LANE_PAIRS_LAYER_SPLIT_V475.kicad_pcb'
GROUPS={'LANE0_RXN':[('U1','65'),('J1','41')],'LANE0_RXP':[('U1','64'),('J1','43')], 'LANE0_TXN':[('U1','67'),('J1','47')],'LANE0_TXP':[('U1','68'),('J1','49')]}
...
def main():
 ...
 print('PASS V475 native four-pair endpoint audit:',result);print('PASS V475 four trace-removal negative controls')
