"""V160: lower only the outboard RTL_1V1 final handoff."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_XTAL_IN_INNER_ENDPOINT_V158.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_LOWER_1V1_HANDOFF_V160.kicad_pcb'
...
def main():
 ...
 remove={((112.0,77.2),(112.0,73.8)),((112.0,73.8),(103.0,73.8))}
 ...
 for x in list(b.GetTracks()):
  if x.GetNetname()=='RTL_1V1' and type(x).__name__=='PCB_VIA' and xy(x.GetPosition())==(112.0,73.8):b.RemoveNative(x)
 tr(b,n,B,(112.0,77.2),(112.0,72.8));via(b,n,(112.0,72.8));tr(b,n,F,(112.0,72.8),(103.0,72.8));tr(b,n,F,(103.0,72.8),(103.0,73.8));via(b,n,(103.0,73.8))
