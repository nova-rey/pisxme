...
seg(ilim,(123.3,87.905),(121,89.8)); seg(gnd,(121,92.2),(120,92.2)); via(gnd,120,92.2)
seg(gnd,(123.3,86.635),(120,86.635)); via(gnd,120,86.635); seg(gnd,(120,86.635),(120,78),B); seg(gnd,(120,78),(115,76.4),F)
seg(gnd,(130,90.8),(132,90.8)); via(gnd,132,90.8)
