"""V1330: move only the TXP long vertical outside the RXN launch transition."""
...
out=H/'PHASE24_RTL9210B_V1058_SUPPORT_LANE_ORIGINAL_J1_V1330.kicad_pcb'
...
tr(F,(94.05,73.2),(90.8,73.2)); tr(F,(90.8,73.2),(90.8,76.8)); vi((90.8,76.8)); tr(B,(90.8,76.8),(90.8,88.0)); vi((90.8,88.0)); tr(F,(90.8,88.0),(134.5,88.0)); tr(F,(134.5,88.0),(134.5,61.0)); vi((134.5,61.0)); tr(B,(134.5,61.0),(135.75,61.0)); vi((135.75,61.0)); tr(F,(135.75,61.0),(135.75,62.725))
