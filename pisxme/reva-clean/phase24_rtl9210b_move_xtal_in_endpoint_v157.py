"""V157: move only the XTAL_IN outboard endpoint around REFCLK."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_MOVE_CLKREQ_J1_V156.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_MOVE_XTAL_IN_ENDPOINT_V157.kicad_pcb'
...
def main():
 ...
 tr(b,n,B,(94.4,76.0),(110.5,75.0));via(b,n,(110.5,75.0));tr(b,n,F,(110.5,75.0),(108.3,75.8))
