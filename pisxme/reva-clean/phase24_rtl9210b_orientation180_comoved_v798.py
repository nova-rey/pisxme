"""V798: orientation-180 QFN with co-moved support pocket and controls."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_COMOVED_V798.kicad_pcb'
...
n=b.FindNet('PEDET'); T(b,n,F,(98.4,66.05),(98.4,54)); T(b,n,F,(98.4,54),(89,54)); T(b,n,F,(89,54),(89,56))
n=b.FindNet('CLKREQ_N'); T(b,n,F,(96.4,66.05),(96.4,58)); T(b,n,F,(96.4,58),(92,58)); T(b,n,F,(92,58),(92,56))
n=b.FindNet('PERST_N'); T(b,n,F,(96,66.05),(96,48)); V(b,n,(96,48)); T(b,n,B,(96,48),(135,48)); T(b,n,B,(135,48),(135,69.5)); V(b,n,(135,69.5)); T(b,n,F,(135,69.5),(136,70.275))
