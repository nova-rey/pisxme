"""V801: orientation-180 controls with CLKREQ_N routed rightward."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_CONTROL_RIGHT_V801.kicad_pcb'
...
for ref,target in {'Y1':(105,60),'C1':(101,60),'C2':(108,60),'R1':(105,56),'R3':(100,54)}.items():
 f=b.FindFootprintByReference(ref); q=f.FindPadByNumber('1').GetPosition(); f.SetPosition(f.GetPosition()+P(*target)-q)
n=b.FindNet('PEDET'); T(b,n,F,(98.4,66.05),(98.4,76.5)); T(b,n,F,(98.4,76.5),(89,76.5)); T(b,n,F,(89,76.5),(89,56))
n=b.FindNet('CLKREQ_N'); T(b,n,F,(96.4,66.05),(96.4,58)); T(b,n,F,(96.4,58),(100,58)); T(b,n,F,(100,58),(100,54))
