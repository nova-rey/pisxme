"""V806: move CLKREQ_N transition above the PERST vertical launch."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_CONTROLS_FINAL_V806.kicad_pcb'
...
n=b.FindNet('CLKREQ_N'); T(b,n,F,(96.4,66.05),(96.4,56)); V(b,n,(96.4,56)); T(b,n,B,(96.4,56),(103,56)); T(b,n,B,(103,56),(103,54))
