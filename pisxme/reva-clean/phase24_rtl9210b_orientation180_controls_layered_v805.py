"""V805: orientation-180 controls with a B.Cu CLKREQ crossover."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_CONTROLS_LAYERED_V805.kicad_pcb'
...
n=b.FindNet('CLKREQ_N'); T(b,n,F,(96.4,66.05),(96.4,64)); V(b,n,(96.4,64)); T(b,n,B,(96.4,64),(103,64)); T(b,n,B,(103,64),(103,54)); V(b,n,(103,54)); T(b,n,F,(103,54),(103,54))
