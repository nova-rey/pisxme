"""V808: lateral separation of the PERST_N transition from CLKREQ_N."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_CONTROLS_V808.kicad_pcb'
...
n=b.FindNet('CLKREQ_N'); T(b,n,F,(96.4,66.05),(96.4,55)); V(b,n,(96.4,55)); T(b,n,B,(96.4,55),(103,55)); V(b,n,(103,55)); T(b,n,F,(103,55),(103,54))
n=b.FindNet('PERST_N'); T(b,n,F,(96,66.05),(96,57)); T(b,n,F,(96,57),(95.2,57)); V(b,n,(95.2,57)); T(b,n,B,(95.2,57),(95.2,46)); T(b,n,B,(95.2,46),(135,46)); T(b,n,B,(135,46),(135,69.5)); V(b,n,(135,69.5)); T(b,n,F,(135,69.5),(136,70.275))
