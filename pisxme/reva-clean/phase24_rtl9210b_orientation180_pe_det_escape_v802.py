"""V802: orientation-180 PEDET escape moved clear of U1 ground pads."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_PEDET_ESCAPE_V802.kicad_pcb'
...
n=b.FindNet('PEDET'); T(b,n,F,(98.4,66.05),(100,66.05)); T(b,n,F,(100,66.05),(100,54)); T(b,n,F,(100,54),(89,54)); T(b,n,F,(89,54),(89,56))
