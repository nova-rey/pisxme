"""V823: move SPISO transition above the adjacent U1 source field."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_ORIENTATION180_SPICS_V810.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_SPISO_HIGH_V823.kicad_pcb'
...
T(b,n,F,(94.05,68.8),(93.2,68.8)); T(b,n,F,(93.2,68.8),(93.2,65.8)); V(b,n,(93.2,65.8))
T(b,n,B,(93.2,65.8),(90.8,65.8)); T(b,n,B,(90.8,65.8),(90.8,54)); T(b,n,B,(90.8,54),(84.5,54)); V(b,n,(84.5,54)); T(b,n,F,(84.5,54),(84.5,50))
