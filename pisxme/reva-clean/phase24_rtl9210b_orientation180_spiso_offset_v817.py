"""V817: offset the SPISO transition below the adjacent source pair."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_ORIENTATION180_SPICS_V810.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_SPISO_OFFSET_V817.kicad_pcb'
...
T(b,n,F,(94.05,68.8),(92,68.8)); T(b,n,F,(92,68.8),(92,67.8)); V(b,n,(92,67.8))
T(b,n,B,(92,67.8),(92,54)); T(b,n,B,(92,54),(84.5,54)); V(b,n,(84.5,54)); T(b,n,F,(84.5,54),(84.5,50))
