"""V819: turn SPISO down before the retained SPICS vertical escape."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_ORIENTATION180_SPICS_V810.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_SPISO_ORTHOGONAL_V819.kicad_pcb'
...
T(b,n,F,(94.05,68.8),(93.2,68.8)); T(b,n,F,(93.2,68.8),(93.2,67.8)); V(b,n,(93.2,67.8))
T(b,n,B,(93.2,67.8),(90.8,67.8)); T(b,n,B,(90.8,67.8),(90.8,54)); T(b,n,B,(90.8,54),(84.5,54)); V(b,n,(84.5,54)); T(b,n,F,(84.5,54),(84.5,50))
