"""V816: move SPISO's layer transition close to its source departure."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_ORIENTATION180_SPICS_V810.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_SPISO_SOURCE_V816.kicad_pcb'
...
T(b,n,F,(94.05,68.8),(93.5,68.8)); V(b,n,(93.5,68.8))
T(b,n,B,(93.5,68.8),(90,68.8)); T(b,n,B,(90,68.8),(90,54)); T(b,n,B,(90,54),(84.5,54)); V(b,n,(84.5,54)); T(b,n,F,(84.5,54),(84.5,50))
