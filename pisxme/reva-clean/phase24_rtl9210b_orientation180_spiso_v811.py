"""V811: add the prior native-tested SPISO F/B handoff to V810."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_ORIENTATION180_SPICS_V810.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_SPISO_V811.kicad_pcb'
...
T(b,n,F,(94.05,68.8),(93.2,68.8)); V(b,n,(93.2,68.8)); T(b,n,B,(93.2,68.8),(91.5,64)); T(b,n,B,(91.5,64),(91.5,52)); T(b,n,B,(91.5,52),(84.5,52)); V(b,n,(84.5,52)); T(b,n,F,(84.5,52),(84.5,50))
