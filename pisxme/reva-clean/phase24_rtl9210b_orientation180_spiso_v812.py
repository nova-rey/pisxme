"""V812: shift the SPISO source transition clear of the SPICS launch."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_ORIENTATION180_SPICS_V810.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ORIENTATION180_SPISO_V812.kicad_pcb'
...
T(b,n,F,(94.05,68.8),(92.0,68.8)); V(b,n,(92.0,68.8)); T(b,n,B,(92.0,68.8),(91.0,64)); T(b,n,B,(91.0,64),(91.0,52)); T(b,n,B,(91.0,52),(84.5,52)); V(b,n,(84.5,52)); T(b,n,F,(84.5,52),(84.5,50))
