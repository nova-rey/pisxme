"""V297: PEDET below-endpoint loop around translated PERST."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_SUPPORT_ROUTE_SPISI_V289.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_PEDET_PERST_LOCAL_V297.kicad_pcb'
...
def main():
 ...
 tr(b,p,F,(90.9,53),(88,53));tr(b,p,F,(88,53),(88,46));via(b,p,(88,46));tr(b,p,B,(88,46),(108,46));tr(b,p,B,(108,46),(108,59.5));via(b,p,(108,59.5));tr(b,p,F,(108,59.5),(108,63.5));tr(b,p,F,(108,63.5),(106.5,63.5));tr(b,p,F,(106.5,63.5),(106.5,62.4));tr(b,p,F,(106.5,62.4),(101.95,62.4));via(b,p,(108,62.4));tr(b,p,B,(108,62.4),(139,62.4));via(b,p,(139,62.4));tr(b,p,F,(139,62.4),(140.75,62.725))
