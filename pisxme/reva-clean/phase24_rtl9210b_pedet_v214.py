"""V214: route R2 PEDET above the retained SPI field."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_PEDET_U18_J1_69_V212.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_PEDET_R2_U18_J1_69_V214.kicad_pcb'
...
def main():
    ...
    add(b,n,pcbnew.B_Cu,(89.0,44.0),(103.2,44.0));add(b,n,pcbnew.B_Cu,(103.2,44.0),(103.2,62.4))
