"""V215: carry the R2 PEDET return around the outboard sideband ends."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_PEDET_U18_J1_69_V212.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_PEDET_R2_U18_J1_69_V215.kicad_pcb'
...
def main():
    ...
    add(b,n,pcbnew.F_Cu,(89.0,48.0),(89.0,44.0));via(b,n,89.0,44.0)
    add(b,n,pcbnew.B_Cu,(89.0,44.0),(141.5,44.0));add(b,n,pcbnew.B_Cu,(141.5,44.0),(141.5,62.4));add(b,n,pcbnew.B_Cu,(141.5,62.4),(139.0,62.4))
