"""V291: PEDET launch shifted west/north of the retained SPI field."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_SUPPORT_ROUTE_SPISI_V289.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_PEDET_ROUTE_V291.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(90.9,53.0),(88.0,53.0));tr(b,n,F,(88.0,53.0),(88.0,46.0));via(b,n,(88.0,46.0));tr(b,n,B,(88.0,46.0),(106.0,46.0));tr(b,n,B,(106.0,46.0),(106.0,62.4));via(b,n,(106.0,62.4));tr(b,n,F,(106.0,62.4),(101.95,62.4));tr(b,n,B,(106.0,62.4),(139.0,62.4));via(b,n,(139.0,62.4));tr(b,n,F,(139.0,62.4),(140.75,62.725))
