"""V1224: PERST_N drops below both accepted support shelves before B.Cu transit."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; BASE=H/'PHASE24_RTL9210B_CLKREQ_EDGE_CORRIDOR_V1211.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_PERST_EDGE_CORRIDOR_V1224.kicad_pcb'
...
add(b,per,[(100.0,73.95),(100.0,84.0)],F); via(b,per,(100.0,84.0)); add(b,per,[(100.0,84.0),(100.0,86.0),(138.0,86.0),(138.0,68.5)],B); via(b,per,(138.0,68.5)); add(b,per,[(138.0,68.5),(138.0,71.5),(136.0,71.5),(136.0,70.275)],F)
