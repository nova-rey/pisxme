"""Saved-board audit for V1224 control departures with negative controls."""
from pathlib import Path
import pcbnew
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_PERST_EDGE_CORRIDOR_V1224.kicad_pcb'
...
for net,xy,padno in [('CLKREQ_N',(98.8,76.0),'13'),('PERST_N',(100.0,84.0),'14')]:
...
print('PASS V1224 native CLKREQ_N and PERST_N endpoint connectivity; both complete source-cohort negative controls PASS')
