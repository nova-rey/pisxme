"""Saved-board audit for V1225 control departures with negative controls."""
from pathlib import Path
import pcbnew
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_PERST_EDGE_CORRIDOR_V1225.kicad_pcb'
...
print('PASS V1225 native CLKREQ_N and PERST_N endpoint connectivity; both complete source-cohort negative controls PASS')
