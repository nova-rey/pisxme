"""V1355: PERST_N below the PEDET support shelf, then direct F.Cu launch."""
from pathlib import Path
import pcbnew

H = Path(__file__).resolve().parent
BASE = H / 'PHASE24_RTL9210B_PERST_LOWER_SHELF_V1354.kicad_pcb'
OUT = H / 'PHASE24_RTL9210B_PERST_LOWER_SHELF_V1355.kicad_pcb'
...
board = pcbnew.LoadBoard(str(BASE)); net = board.FindNet('PERST_N'); assert net is not None
clear_net(board, 'PERST_N')
track(board, net, F, (100.0, 73.95), (100.0, 81.0)); track(board, net, F, (100.0, 81.0), (102.0, 81.0))
via(board, net, (102.0, 81.0)); track(board, net, B, (102.0, 81.0), (134.0, 81.0)); via(board, net, (134.0, 81.0))
track(board, net, F, (134.0, 81.0), (134.0, 70.275)); track(board, net, F, (134.0, 70.275), (136.0, 70.275))
