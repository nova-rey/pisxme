"""V224: PERST source dogbone above U1.14 adjacent controls."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_PEDET_R2_U18_J1_69_V215.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_PERST_U114_J1_50_V224.kicad_pcb'
...
def main():
    ...
    add(b,n,pcbnew.F_Cu,(101.95,60.0),(102.4,58.8));via(b,n,102.4,58.8)
    add(b,n,pcbnew.B_Cu,(102.4,58.8),(97.5,58.8));add(b,n,pcbnew.B_Cu,(97.5,58.8),(97.5,72.0));add(b,n,pcbnew.B_Cu,(97.5,72.0),(134.5,72.0));via(b,n,134.5,72.0)
