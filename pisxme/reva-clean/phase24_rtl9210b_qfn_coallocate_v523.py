"""V523: move the RTL_3V3 departure above the F.Cu 1V1 channel."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; src=H/'PHASE24_RTL9210B_QFN_COALLOCATE_V520.kicad_pcb'; out=H/'PHASE24_RTL9210B_QFN_COALLOCATE_V523.kicad_pcb'
...
# Upward F.Cu departure avoids the existing x=101.0 F.Cu 1V1 channel.
tr(b,n,F,a,(102.8,56.8)); tr(b,n,F,(102.8,56.8),(99.5,56.8)); via(b,n,(99.5,56.8)); tr(b,n,B,(99.5,56.8),(99.5,60.4)); via(b,n,(99.5,60.4)); tr(b,n,F,(99.5,60.4),(102.05,60.4))
