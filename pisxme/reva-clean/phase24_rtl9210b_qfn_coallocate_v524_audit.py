"""V524 native RTL_3V3 connectivity and exact branch negative control."""
import pcbnew
from pathlib import Path
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_QFN_COALLOCATE_V524.kicad_pcb'
...
assert reach(b,q['U1','20'],q['U1','34']) and reach(b,q['U1','20'],q['C3','1'])
print('PASS V524 native U1.20/U1.34 -> C3.1 RTL_3V3 connectivity')
