"""V528 native U1.39 rail connectivity and exact branch negative control."""
import pcbnew
from pathlib import Path
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_QFN_COALLOCATE_V528.kicad_pcb'
...
print('PASS V528 native U1.20/U1.34/U1.39 -> C3.1 RTL_3V3 connectivity')
...
for x in t.GetTracks():
 ...
 if (aa,zz)==((100.5,60.4),(100.5,58.05)) or (aa,zz)==((100.5,58.05),(102.8,58.05)): branch.append(x)
...
print('PASS V528 exact U1.39 branch negative control')
