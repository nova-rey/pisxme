"""V534: move the U1.52 RTL_3V3 via below the XTAL_IN handoff."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_QFN_COALLOCATE_V532.kicad_pcb'; out=H/'PHASE24_RTL9210B_QFN_COALLOCATE_V534.kicad_pcb'
...
tr(b,n,F,(101.5,67.5),(101.5,68.5)); via(b,n,(101.5,68.5)); tr(b,n,B,(101.5,68.5),(101.5,65.5))
