"""V534 native four-source 3V3 connectivity and U1.52 negative control."""
import pcbnew
from pathlib import Path
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_QFN_COALLOCATE_V534.kicad_pcb'
...
print('PASS V534 native four-source RTL_3V3 connectivity')
...
for x in t.GetTracks():
 ...
 if isinstance(x,pcbnew.PCB_VIA):
  ...
  if (aa,zz) in [((101.5,67.5),(101.5,68.5)),((101.5,68.5),(101.5,65.5))]: branch.append(x)
assert branch
for x in branch:t.RemoveNative(x)
q=pads(t); assert not reach(t,q['U1','52'],q['U1','20'])
print('PASS V534 exact U1.52 branch negative control')
