"""V537 native U1.40 1V1 connectivity and exact branch negative control."""
import pcbnew
from pathlib import Path
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_QFN_COALLOCATE_V537.kicad_pcb'
...
b=pcbnew.LoadBoard(str(PCB)); q=pads(b); assert reach(b,q['U1','40'],q['C4','1']); print('PASS V537 native U1.40 -> C4.1 RTL_1V1 connectivity')
...
for x in t.GetTracks():
 ...
 if (aa,zz) in [((102.05,60.8),(101.5,60.8)),((101.5,60.8),(101.5,61.5)),((101.5,61.5),(101.5,57.3))]: branch.append(x)
assert branch
for x in branch:t.RemoveNative(x)
q=pads(t); assert not reach(t,q['U1','40'],q['C4','1']); print('PASS V537 exact U1.40 branch negative control')
