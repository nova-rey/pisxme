"""V550 native U1.55 1V1 connectivity and exact branch negative control."""
import pcbnew
from pathlib import Path
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_QFN_COALLOCATE_V550.kicad_pcb'
...
def reach(b,a,z):
 ...
 return key(z) in s
b=pcbnew.LoadBoard(str(PCB));q=pads(b);assert reach(b,q['U1','55'],q['C4','1']);print('PASS V550 native U1.55 -> C4.1 RTL_1V1 connectivity')
...
for x in t.GetTracks():
 ...
 if (aa,zz) in [((104.0,65.95),(104.0,67.0)),((104.0,67.0),(102.9,67.0)),((102.9,67.0),(102.9,64.8))]:branch.append(x)
assert branch
for x in branch:t.RemoveNative(x)
q=pads(t);assert not reach(t,q['U1','55'],q['C4','1']);print('PASS V550 exact U1.55 branch negative control')
