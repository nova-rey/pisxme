"""V251: co-author U1.52 RTL_3V3 with the V250 QFN source field."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_RTL1V1_U136_U139_U152_V242.kicad_pcb';OUT=HERE/'PHASE24_RTL9210B_RTL1V1_U136_U139_U152_V251.kicad_pcb';F,B=pcbnew.F_Cu,pcbnew.B_Cu;W=pcbnew.FromMM(.13)
...
def main():
 ...
 tr(b,rp,F,(98.4,65.95),(98.4,67.6));tr(b,rp,F,(98.4,67.6),(97.4,68.6));via(b,rp,(97.4,68.6));tr(b,rp,B,(97.4,68.6),(97.4,60.0));tr(b,rp,B,(97.4,60.0),(98.2,60.0))
 ...
 tr(b,r3,F,(94.8,65.95),(94.8,64.6));tr(b,r3,F,(94.8,64.6),(93.6,64.6));tr(b,r3,F,(93.6,64.6),(93.0,64.8));via(b,r3,(93.0,64.8));tr(b,r3,B,(93.0,64.8),(93.0,56.5));tr(b,r3,B,(93.0,56.5),(93.8,56.5))
