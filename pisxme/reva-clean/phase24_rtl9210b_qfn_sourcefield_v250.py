"""V250: parallel lower-edge QFN source departures at 0.4-mm pitch."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_RTL1V1_U136_U139_U152_V242.kicad_pcb';OUT=HERE/'PHASE24_RTL9210B_RTL1V1_U136_U139_U152_V250.kicad_pcb';F,B=pcbnew.F_Cu,pcbnew.B_Cu;W=pcbnew.FromMM(.13)
...
def main():
 b=pcbnew.LoadBoard(str(BASE));r1=b.FindNet('RTL_1V1');rp=b.FindNet('REFCLK_P');rn=b.FindNet('REFCLK_N')
