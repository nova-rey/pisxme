"""Saved-board V1234 REFCLK endpoint and source-cohort audit."""
from pathlib import Path
import pcbnew
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_REFCLK_BOUNDARY_CROSS_V1234.kicad_pcb'
...
print('PASS V1234 native REFCLK_P/N endpoint connectivity; complete pair source-cohort negative controls PASS')
