"""V450: early RX_P transition plus lower REFCLK_N trunk."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_REFCLK_DEEP_JOG_V448.kicad_pcb'; out=H/'PHASE24_RTL9210B_REFCLK_LANE_VIA_COALLOCATE_V450.kicad_pcb'
...
nn=b.FindNet('REFCLK_N'); seg(b,nn,F,(109.95,61.2),(109.2,61.2)); seg(b,nn,F,(109.2,61.2),(109.2,65.0)); via(b,nn,(109.2,65.0)); seg(b,nn,B,(109.2,65.0),(109.2,68)); seg(b,nn,B,(109.2,68),(136.75,68)); seg(b,nn,B,(136.75,68),(136.75,64.5)); via(b,nn,(136.75,64.5)); seg(b,nn,F,(136.75,64.5),(136.75,62.725))
rxp=b.FindNet('LANE0_RXP'); seg(b,rxp,F,(109.95,60.4),(110.6,60.4)); via(b,rxp,(110.6,60.4)); seg(b,rxp,B,(110.6,60.4),(110.6,66.5)); via(b,rxp,(110.6,66.5)); seg(b,rxp,B,(110.6,66.5),(132,66.5)); seg(b,rxp,F,(132,66.5),(134.25,66.5)); seg(b,rxp,F,(134.25,66.5),(134.25,62.725))
