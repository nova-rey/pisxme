"""Saved-board V1236 REFCLK endpoint and source-cohort audit."""
from pathlib import Path
import pcbnew
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_REFCLK_OPPOSITE_ESCAPE_V1236.kicad_pcb'
...
for net,xy,padno in [('REFCLK_P',(93.2,78.5),'61'),('REFCLK_N',(95.0,79.2),'62')]:
...
print('PASS V1236 native REFCLK_P/N endpoint connectivity; complete pair source-cohort negative controls PASS')
