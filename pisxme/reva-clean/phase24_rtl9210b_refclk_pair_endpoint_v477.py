"""V477: REFCLK corridor below crystal with inward N handoff."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_ROTATED_SOURCE_PLANAR_V462.kicad_pcb'; out=H/'PHASE24_RTL9210B_REFCLK_PAIR_ENDPOINT_V477.kicad_pcb'
...
for name,pad,q,mid,row,side,entry,dst in [('REFCLK_N','62',(112,70.1),(118,70.1),(118,52),(136,52),(136.75,64.5),(136.75,62.725)),('REFCLK_P','61',(111,71),(119,71),(119,51),(137.25,51),(137.25,60.5),(137.25,62.725))]:
