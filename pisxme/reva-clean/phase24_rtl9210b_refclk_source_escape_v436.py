"""V436: isolate REFCLK source escapes from the native U1 pad field."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_CLKREQ_QFN_CLEARANCE_V431.kicad_pcb'; out=H/'PHASE24_RTL9210B_REFCLK_SOURCE_ESCAPE_V436.kicad_pcb'
...
route('REFCLK_P',(109.95,61.6),(137.25,62.725),(112.5,61.0),(112.5,58.0),(135.5,58.0))
route('REFCLK_N',(109.95,61.2),(136.75,62.725),(108.5,61.2),(108.5,66.0),(135.0,66.0))
