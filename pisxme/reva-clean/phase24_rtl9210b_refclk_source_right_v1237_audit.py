"""Saved-board V1237 REFCLK endpoint and source-cohort audit."""
from pathlib import Path
import pcbnew
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_REFCLK_SOURCE_RIGHT_V1237.kicad_pcb'
...
for net,xy,padno in [('REFCLK_P',(95.2,65.5),'61'),('REFCLK_N',(96.0,66.2),'62')]:
...
print('PASS V1237 native REFCLK_P/N endpoint connectivity; complete pair source-cohort negative controls PASS')
