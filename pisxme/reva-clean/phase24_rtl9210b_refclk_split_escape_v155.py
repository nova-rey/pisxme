"""V155: split REFCLK_N locally around U1 pad 63 on the V154 basis."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_1V1_OUTBOARD_HANDOFF_V154.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_REFCLK_SPLIT_ESCAPE_V155.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(98.8,73.95),(98.8,75.0));via(b,n,(98.8,75.0));tr(b,n,B,(98.8,75.0),(100.0,75.0));via(b,n,(100.0,75.0));tr(b,n,F,(100.0,75.0),(100.0,74.2));tr(b,n,F,(100.0,74.2),(136.25,74.2));via(b,n,(136.25,74.2));tr(b,n,B,(136.25,74.2),(136.25,62.0));via(b,n,(136.25,62.0));tr(b,n,F,(136.25,62.0),(136.75,62.725))
