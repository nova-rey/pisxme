"""Saved-board V1235 REFCLK endpoint and source-cohort audit."""
from pathlib import Path
import pcbnew
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_REFCLK_STAGGERED_SOURCE_V1235.kicad_pcb'
...
for net,xy,padno in [('REFCLK_P',(91.2,78.5),'61'),('REFCLK_N',(91.6,79.2),'62')]:
...
print('PASS V1235 native REFCLK_P/N endpoint connectivity; complete pair source-cohort negative controls PASS')
