"""V182: move the RSET B.Cu corridor below both crystal traces."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_REFCLK_SUPPORT_RELOCATED_V181.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_REFCLK_SUPPORT_RELOCATED_V182.kicad_pcb"
...
def tr(board, net, layer, start, end):
...
def main():
    ...
    tr(board, rset, F, (94.05, 65.2), (93.7, 66.0))
    tr(board, rset, F, (93.7, 66.0), (93.7, 68.5))
    via(board, rset, (93.7, 68.5))
    tr(board, rset, B, (93.7, 68.5), (83.4, 68.5))
