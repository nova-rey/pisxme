"""V183: transition RSET left of the crystal paths, then stay below them."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_REFCLK_SUPPORT_RELOCATED_V182.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_REFCLK_SUPPORT_RELOCATED_V183.kicad_pcb"
...
def main():
    ...
    tr(board, rset, F, (93.4, 65.2), (93.4, 67.8))
    via(board, rset, (93.4, 67.8))
    tr(board, rset, B, (93.4, 67.8), (83.4, 68.5))
