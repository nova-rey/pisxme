"""V169: move the separated upper REFCLK trunks above SPI/1V1 fields."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent; BASE=HERE/'PHASE24_RTL9210B_LOWER_1V1_HANDOFF_V160.kicad_pcb'; OUT=HERE/'PHASE24_RTL9210B_REFCLK_SUPPORT_V169.kicad_pcb'; F,B=pcbnew.F_Cu,pcbnew.B_Cu
W=.13208
...
def main():
 ...
 tr(b,p,B,(97.0,76.0),(93.0,62.8));tr(b,p,B,(93.0,62.8),(138.5,62.8));tr(b,p,B,(138.5,62.8),(138.5,61.0));via(b,p,(138.5,61.0));tr(b,p,F,(138.5,61.0),(137.25,62.725))
 tr(b,n,B,(102.0,76.0),(102.0,63.5));tr(b,n,B,(102.0,63.5),(136.75,63.5));tr(b,n,B,(136.75,63.5),(136.75,61.0));via(b,n,(136.75,61.0));tr(b,n,F,(136.75,61.0),(136.75,62.725))
