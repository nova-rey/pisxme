"""V451: stagger REFCLK_N upward before its B.Cu transition."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_CLKREQ_QFN_CLEARANCE_V431.kicad_pcb'; out=H/'PHASE24_RTL9210B_REFCLK_UPPER_N_JOG_V451.kicad_pcb'
...
nn=b.FindNet('REFCLK_N'); seg(b,nn,F,(109.95,61.2),(111.5,61.2)); seg(b,nn,F,(111.5,61.2),(111.5,60.8)); via(b,nn,(111.5,60.8)); seg(b,nn,B,(111.5,60.8),(111.5,66)); seg(b,nn,B,(111.5,66),(136.75,66)); seg(b,nn,B,(136.75,66),(136.75,64.5)); via(b,nn,(136.75,64.5)); seg(b,nn,F,(136.75,64.5),(136.75,62.725))
