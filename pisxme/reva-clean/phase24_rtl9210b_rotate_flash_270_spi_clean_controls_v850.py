"""V850: clean ordered 270-degree fanout with controls moved clear."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_ROTATE_FLASH_270_SUPPORT_V844.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_ROTATE_FLASH_270_SPI_CLEAN_CONTROLS_V850.kicad_pcb'
...
for t in list(b.GetTracks()):
 if t.GetNetname() in ('SPISI','SPICLK','SPISO3','SPISO','SPICS','GND'): b.RemoveNative(t)
