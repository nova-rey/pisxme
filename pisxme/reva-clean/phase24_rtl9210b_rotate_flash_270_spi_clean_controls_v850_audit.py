"""Saved-board endpoint and trace-removal audit for the V850 SPI trio."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
PCB=H/'PHASE24_RTL9210B_ROTATE_FLASH_270_SPI_CLEAN_CONTROLS_V850.kicad_pcb'
PAIRS={'SPISI':(('U1','18'),('U2','5')),'SPICLK':(('U1','19'),('U2','6')),'SPISO3':(('U1','22'),('U2','7'))}
