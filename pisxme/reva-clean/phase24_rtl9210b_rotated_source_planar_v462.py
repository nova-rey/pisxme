"""V462: widened 0.9-mm-spaced planar rotated source fanout."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_CLKREQ_QFN_CLEARANCE_V431.kicad_pcb'; out=H/'PHASE24_RTL9210B_ROTATED_SOURCE_PLANAR_V462.kicad_pcb'
...
srcs=[('REFCLK_P','61',(111.0,71.0)),('REFCLK_N','62',(112.0,70.1)),('LANE0_RXP','64',(113.0,69.2)),('LANE0_RXN','65',(114.0,68.3)),('LANE0_TXN','67',(115.0,67.4)),('LANE0_TXP','68',(116.0,66.5))]
for name,pad,q in srcs:
 n=b.FindNet(name); p=u.FindPadByNumber(pad); pp=p.GetPosition(); a=(pcbnew.ToMM(pp.x),pcbnew.ToMM(pp.y)); seg(b,n,a,(a[0],q[1])); seg(b,n,(a[0],q[1]),q); via(b,n,q)
