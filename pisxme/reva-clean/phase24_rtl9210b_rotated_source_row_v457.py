"""V457: rotated RTL9210B monotonic source-via row feasibility fixture."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_CLKREQ_QFN_CLEARANCE_V431.kicad_pcb'; out=H/'PHASE24_RTL9210B_ROTATED_SOURCE_ROW_V457.kicad_pcb'
...
srcs=[('REFCLK_P','61',(104.0,68.0)),('REFCLK_N','62',(105.5,68.0)),('LANE0_RXP','64',(107.0,68.0)),('LANE0_RXN','65',(108.5,68.0)),('LANE0_TXN','67',(110.0,68.0)),('LANE0_TXP','68',(111.5,68.0))]
