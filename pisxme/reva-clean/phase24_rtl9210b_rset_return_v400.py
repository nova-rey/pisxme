"""V400: move only the RSET return endpoint clear of the RTL_3V3 trunk."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_XTALIN_VIA_REPOSITIONED_V397.kicad_pcb'; out=H/'PHASE24_RTL9210B_RSET_RETURN_V400.kicad_pcb'
