"""V502: C4 beside U1.16; F.Cu-only local escape around the source field."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; src=H/'PHASE24_RTL9210B_SOURCE_FIELD_V498.kicad_pcb'; out=H/'PHASE24_RTL9210B_RTL1V1_U116_V502.kicad_pcb'
...
a=mm(u.FindPadByNumber('16').GetPosition()); z=mm(c.FindPadByNumber('1').GetPosition()); pts=[a,(108.8,a[1]),(108.8,61.5),(113.2,61.5),z]
