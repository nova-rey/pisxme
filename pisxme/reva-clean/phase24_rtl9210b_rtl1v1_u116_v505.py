"""V505: approach relocated C4.1 from below to clear its GND pad."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; src=H/'PHASE24_RTL9210B_SOURCE_FIELD_V498.kicad_pcb'; out=H/'PHASE24_RTL9210B_RTL1V1_U116_V505.kicad_pcb'
...
a=mm(u.FindPadByNumber('16').GetPosition()); j=mm(u.FindPadByNumber('36').GetPosition()); z=mm(c.FindPadByNumber('1').GetPosition()); pts=[a,(101.0,a[1]),(101.0,61.2),(z[0],61.2),z]
