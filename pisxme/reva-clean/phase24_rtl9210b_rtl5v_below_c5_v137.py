"""V137: route RTL_5V above CLKREQ and enter C5 from below."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_CLKREQ_R3_RAIL_OVERPASS_V131.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_RTL5V_BELOW_C5_V137.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(103.5,66.4),(104.5,66.4));tr(b,n,F,(104.5,66.4),(104.5,65.8));tr(b,n,F,(104.5,65.8),(114.5,65.8));via(b,n,(114.5,65.8));tr(b,n,B,(114.5,65.8),(114.5,70.5));via(b,n,(114.5,70.5));tr(b,n,F,(114.5,70.5),(115.5,70.5));tr(b,n,F,(115.5,70.5),(116.4,69.0))
