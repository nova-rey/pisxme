"""V136: left-side C5.1 launch, clear of CLKREQ and adjacent grounds."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_CLKREQ_R3_RAIL_OVERPASS_V131.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_RTL5V_C5_LEFT_LAUNCH_V136.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(103.5,66.4),(104.5,66.4));tr(b,n,F,(104.5,66.4),(114.5,66.4));via(b,n,(114.5,66.4));tr(b,n,B,(114.5,66.4),(114.5,67.0));via(b,n,(114.5,67.0));tr(b,n,F,(114.5,67.0),(114.5,68.2));tr(b,n,F,(114.5,68.2),(115.5,68.2));tr(b,n,F,(115.5,68.2),(116.4,69.0))
