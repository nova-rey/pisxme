"""Native saved-board U1.17 to C5.1 audit and negative control."""
import pcbnew
from pathlib import Path
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_RTL5V_U117_V491.kicad_pcb';G=[('U1','17'),('C5','1')]
...
def main():
 ...
 assert not ok(t);print('PASS V491 native U1.17-to-C5.1 connectivity; one trace-removal negative control PASS')
