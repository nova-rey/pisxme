...
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_RTL5V_U133_V493.kicad_pcb';G=[('U1','33'),('C5','1')]
...
def main():
 ...
 assert not ok(t);print('PASS V493 native U1.33-to-C5.1 connectivity; one trace-removal negative control PASS')
