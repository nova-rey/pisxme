"""V134: clear the U1.17 1V1 via and PERST before entering C5."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_CLKREQ_R3_RAIL_OVERPASS_V131.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_RTL5V_VIA_AWARE_V134.kicad_pcb'
...
def main():
 ...
 # Source join, co-authored above the SPI field.
 ...
 # Continue above CLKREQ, then drop on B.Cu across PERST into C5.
 tr(b,n,F,(103.5,66.4),(104.5,66.4));tr(b,n,F,(104.5,66.4),(115.0,66.4));via(b,n,(115.0,66.4));tr(b,n,B,(115.0,66.4),(115.0,69.0));via(b,n,(115.0,69.0));tr(b,n,F,(115.0,69.0),(116.4,69.0))
