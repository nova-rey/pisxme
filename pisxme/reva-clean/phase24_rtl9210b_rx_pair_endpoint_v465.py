"""V465: RX pair endpoint corridor, isolated from REFCLK/TX continuation."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_ROTATED_SOURCE_PLANAR_V462.kicad_pcb'; out=H/'PHASE24_RTL9210B_RX_PAIR_ENDPOINT_V465.kicad_pcb'
...
for name,pad,q,mid,handoff,dst in [
 ('LANE0_RXN','65',(114,68.3),(124,68.3),(133.75,64.5),(133.75,62.725)),
