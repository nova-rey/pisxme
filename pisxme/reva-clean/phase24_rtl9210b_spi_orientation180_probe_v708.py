"""V708: disposable 180-degree QFN/flash SPI source-field probe."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SUPPORT_RELOCATION_5V_U117_V702.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V708.kicad_pcb'
...
flash=b.FindFootprintByReference('U2')
flash.SetPosition(pcbnew.VECTOR2I_MM(82.0,58.0))
