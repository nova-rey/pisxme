"""V711: V710 with native zone refill before placement judgment."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SUPPORT_RELOCATION_5V_U117_V702.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V711.kicad_pcb'
...
flash=b.FindFootprintByReference('U2');flash.SetPosition(flash.GetPosition()+pcbnew.VECTOR2I_MM(-42.5,0))
