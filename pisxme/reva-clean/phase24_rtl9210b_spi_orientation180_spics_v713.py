"""V713: first SPICS channel on the clean V712 orientation/placement basis."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_SPICS_V713.kicad_pcb'
F=pcbnew.F_Cu
...
path=[(94.05,69.2),(92.0,69.2),(92.0,50.0),(83.3,50.0)]
