"""V714: SPICS approach from the west/north, clear of U2's flash pad row."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_SPICS_V714.kicad_pcb'
F=pcbnew.F_Cu
...
path=[(94.05,69.2),(93.5,69.2),(93.5,49.0),(83.3,49.0),(83.3,50.0)]
