"""V715: SPICS west vertical moved clear of U1.19 and R3."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_PROBE_V712.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_SPI_ORIENTATION180_SPICS_V715.kicad_pcb'
F=pcbnew.F_Cu
...
path=[(94.05,69.2),(92.5,69.2),(92.5,49.0),(83.3,49.0),(83.3,50.0)]
