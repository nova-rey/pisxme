"""V206: sub-millimeter C1 vertical offset on the V202 basis."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_SPI_SOURCE_FIELD_V202.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_SPI_SOURCE_FIELD_V206.kicad_pcb"
...
def main():
    board = pcbnew.LoadBoard(str(BASE)); board.FindFootprintByReference("C1").SetPosition(P(89.0, 60.8))
    ...
    tr(board, net, B, (94.5, 67.2), (89.8, 61.0)); via(board, net, (89.8, 61.0)); tr(board, net, F, (89.8, 61.0), (89.3, 60.0)); tr(board, net, F, (89.3, 60.0), (89.6, 60.8))
