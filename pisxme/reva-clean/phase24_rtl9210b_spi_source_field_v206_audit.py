"""Saved native connectivity audit and negative controls for V206."""
from pathlib import Path
import tempfile
import pcbnew

HERE = Path(__file__).resolve().parent
PCB = HERE / "PHASE24_RTL9210B_SPI_SOURCE_FIELD_V206.kicad_pcb"
...
def main():
    ...
    print("V206 native rail/SPI/crystal connectivity PASS; four negative controls PASS")
