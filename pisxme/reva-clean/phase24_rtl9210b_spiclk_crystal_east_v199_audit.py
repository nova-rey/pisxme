"""Saved native connectivity audit and negative controls for V199."""
from pathlib import Path
import tempfile
import pcbnew

HERE = Path(__file__).resolve().parent
PCB = HERE / "PHASE24_RTL9210B_SPICLK_CRYSTAL_EAST_V199.kicad_pcb"
EXPECT = {
...
def main():
    ...
    print("V199 native crystal/RSET/SPICLK connectivity PASS; four negative controls PASS")
