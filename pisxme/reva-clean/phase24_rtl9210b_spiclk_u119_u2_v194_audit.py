"""Saved native connectivity audit and negative control for V194."""
from pathlib import Path
import tempfile
import pcbnew

HERE = Path(__file__).resolve().parent
PCB = HERE / "PHASE24_RTL9210B_SPICLK_U119_U2_V194.kicad_pcb"
EXPECTED = {("U1", "19"), ("U2", "6")}
...
def main():
    ...
    assert EXPECTED <= pads(board, "U1", "19"), pads(board, "U1", "19")
    ...
    with tempfile.NamedTemporaryFile(suffix=".kicad_pcb") as handle:
        ...
        assert not EXPECTED <= pads(broken, "U1", "19")
    print("V194 native U1.19/U2.6 SPICLK connectivity PASS; trace-removal negative control PASS")
