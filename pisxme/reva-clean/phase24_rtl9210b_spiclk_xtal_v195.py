"""V195: repair SPICLK pad escape and relocate the XTAL_IN transition via."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_SPISO_U123_U2_V193.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_SPICLK_XTAL_V195.kicad_pcb"
...
def main():
    ...
    # Keep the source pad column vertical until below the adjacent SPISI pad.
    ...
    # Preserve the V184 crystal topology but move only the XTAL_IN transition
    # away from the SPICLK vertical landing column.
    tr(board, xtal, F, (95.2, 65.95), (94.5, 67.2))
    via(board, xtal, (94.5, 67.2))
    tr(board, xtal, B, (94.5, 67.2), (88.4, 61.0))
    via(board, xtal, (88.4, 61.0))
    tr(board, xtal, F, (88.4, 61.0), (87.3, 60.0))
