"""Saved native connectivity audit and negative controls for V195."""
from pathlib import Path
import tempfile
import pcbnew

HERE = Path(__file__).resolve().parent
PCB = HERE / "PHASE24_RTL9210B_SPICLK_XTAL_V195.kicad_pcb"
...
def main():
    ...
    assert {("U1", "53"), ("Y1", "1"), ("C1", "1")} <= pads(board, "U1", "53")
    for name, ref, number, expected in (
    ...
    print("V195 native SPICLK/XTAL_IN connectivity PASS; two negative controls PASS")
