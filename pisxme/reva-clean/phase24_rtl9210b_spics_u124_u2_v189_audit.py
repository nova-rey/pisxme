"""Saved native connectivity audit and negative control for V189."""
from pathlib import Path
import tempfile
import pcbnew

HERE = Path(__file__).resolve().parent
PCB = HERE / "PHASE24_RTL9210B_SPICS_U124_U2_V189.kicad_pcb"
EXPECTED = {("U1", "24"), ("U2", "1")}
...
def main():
    ...
    assert EXPECTED <= pads(board, "U1", "24"), pads(board, "U1", "24")
    ...
    with tempfile.NamedTemporaryFile(suffix=".kicad_pcb") as handle:
        ...
        assert not EXPECTED <= pads(broken, "U1", "24")
    print("V189 native U1.24/U2.1 SPICS connectivity PASS; trace-removal negative control PASS")
