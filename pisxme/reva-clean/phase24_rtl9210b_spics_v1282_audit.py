"""V1282 native SPICS endpoint and saved-board negative control."""
from pathlib import Path
import pcbnew

P=Path(__file__).resolve().parent/'PHASE24_RTL9210B_SPICS_AROUND_RXN_V1282.kicad_pcb'
def pads(b):
...
print('PASS V1282 native U1.24-to-U2.1 SPICS endpoint and saved-board negative control')
