"""V1287 native SPICS endpoint and saved-board negative control."""
from pathlib import Path
import pcbnew
P=Path(__file__).resolve().parent/'PHASE24_RTL9210B_SPICS_OUTBOARD_ESCAPE_V1287.kicad_pcb'
...
print('PASS V1287 native U1.24-to-U2.1 SPICS endpoint and saved-board negative control')
