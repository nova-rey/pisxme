"""V190: disposable SPISO U1.23-to-U2.2 parallel upper-corridor route."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_SPICS_U124_U2_V189.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_SPISO_U123_U2_V190.kicad_pcb"
...
def main():
    ...
    tr(board, net, F, (99.2, 58.05), (99.2, 51.5))
    via(board, net, (99.2, 51.5))
    tr(board, net, B, (99.2, 51.5), (83.0, 51.5))
    via(board, net, (83.0, 51.5))
    tr(board, net, F, (83.0, 51.5), (83.0, 72.0))
