"""Saved native connectivity audit and negative control for V191."""
from pathlib import Path
import tempfile
import pcbnew

HERE = Path(__file__).resolve().parent
PCB = HERE / "PHASE24_RTL9210B_SPISO_U123_U2_V191.kicad_pcb"
EXPECTED = {("U1", "23"), ("U2", "2")}
...
def main():
    ...
    print("V191 native U1.23/U2.2 SPISO connectivity PASS; trace-removal negative control PASS")
