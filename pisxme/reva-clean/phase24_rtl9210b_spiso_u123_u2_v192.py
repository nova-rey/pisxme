"""V192: threaded SPISO escape between SPICS and RTL_3V3 fields."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_SPICS_U124_U2_V189.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_SPISO_U123_U2_V192.kicad_pcb"
...
def main():
    ...
    tr(board, net, F, (99.2, 58.05), (99.4, 57.2))
    tr(board, net, F, (99.4, 57.2), (99.4, 50.5))
    via(board, net, (99.4, 50.5))
    tr(board, net, B, (99.4, 50.5), (83.0, 50.5))
    via(board, net, (83.0, 50.5))
    tr(board, net, F, (83.0, 50.5), (83.0, 67.5))
    tr(board, net, F, (83.0, 67.5), (82.6, 68.0))
    tr(board, net, F, (82.6, 68.0), (82.6, 69.2))
    tr(board, net, F, (82.6, 69.2), (83.0, 69.2))
    tr(board, net, F, (83.0, 69.2), (83.0, 72.0))
