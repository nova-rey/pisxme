"""V193: move the SPISO destination dogleg above the RSET pad band."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_SPICS_U124_U2_V189.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_SPISO_U123_U2_V193.kicad_pcb"
...
def main():
    ...
    tr(board, net, F, (83.0, 50.5), (83.0, 64.5))
    tr(board, net, F, (83.0, 64.5), (82.6, 65.0))
    tr(board, net, F, (82.6, 65.0), (82.6, 69.5))
    tr(board, net, F, (82.6, 69.5), (83.0, 72.0))
