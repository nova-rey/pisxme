"""V368: move right-side RTL_1V1 trunks to In2 around XTAL_OUT B.Cu."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; BASE=H/'PHASE24_RTL9210B_RTL3V3_ROUTE_V342.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V368.kicad_pcb'
...
def main():
 ...
 for a,z in [((103.2,56.8),(100,56.8)),((100,56.8),(100,51.5)),((100,51.5),(115.5,51.5)),((99.6,61.6),(97.5,61.6)),((97.5,61.6),(97.5,75)),((97.5,75),(114.8,75)),((102,69),(102,75)),((106,69),(106,75)),((108.8,69),(108.8,75)),((111.5,63),(114.8,63)),((112,61),(114.8,61)),((112,59.5),(114.8,59.5)),((114.8,59.5),(114.8,75)),((115.5,52),(115.5,75))]:
  s(b,n,B if (a,z) in [((103.2,56.8),(100,56.8)),((100,56.8),(100,51.5)),((99.6,61.6),(97.5,61.6)),((97.5,61.6),(97.5,75))] else L,a,z)
