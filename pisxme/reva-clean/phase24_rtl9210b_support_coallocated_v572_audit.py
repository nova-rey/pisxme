"""Native saved-board audit for V572 plus connectivity negative controls."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; PCB=H/'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V572_3V3_BRIDGE.kicad_pcb'
...
def main():
 ...
 print('PASS V572 native 5V/3V3 endpoint connectivity; trace-removal negative controls PASS')
