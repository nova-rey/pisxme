"""Native saved-board audit for V574 and removal negative controls."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; PCB=H/'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V574_COUPLED_POWER_FIELD.kicad_pcb'
...
def main():
 ...
 print('PASS V574 native 5V/3V3 endpoint connectivity; trace-removal negative controls PASS')
