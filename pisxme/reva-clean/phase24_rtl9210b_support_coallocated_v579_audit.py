"""Native saved-board audit for the straight-source V579 candidate."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; PCB=H/'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V579_STRAIGHT_SOURCE.kicad_pcb'
...
def main():
 ...
 print('PASS V579 native 5V/3V3 endpoint connectivity; trace-removal negative controls PASS')
