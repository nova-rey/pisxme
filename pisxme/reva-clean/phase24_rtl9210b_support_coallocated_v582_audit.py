"""Native saved-board audit for V582 and independent rail negative controls."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; PCB=H/'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V582_3V3_GAP.kicad_pcb'
...
def main():
 ...
 print('PASS V582 native 5V/3V3 endpoint connectivity; trace-removal negative controls PASS')
