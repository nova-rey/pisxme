"""V592: complete PEDET using an all-F.Cu outer perimeter."""
from pathlib import Path
import pcbnew

H = Path(__file__).resolve().parent
base = H / 'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V590_PEDET_TOP_PERIMETER.kicad_pcb'
out = H / 'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V592_PEDET_FCU_PERIMETER.kicad_pcb'
...
for a, z in [
    ...
    ((143.0, 62.725), (143.0, 47.0)),
    ((143.0, 47.0), (106.4, 47.0)),
]:
    seg(b, n, a, z)
b.BuildListOfNets()
