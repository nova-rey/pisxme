"""Native saved-board audit for V594; expected groups supply assertions only."""
from pathlib import Path
import pcbnew

H = Path(__file__).resolve().parent
PCB = H / 'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V594_PEDET_OUTER_PERIMETER.kicad_pcb'
GROUPS = {
...
def main():
    ...
    print('PASS V594 native 5V/3V3/PEDET connectivity; independent trace-removal negative controls PASS')
