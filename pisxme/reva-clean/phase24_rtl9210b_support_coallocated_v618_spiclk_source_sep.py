"""V618: separate SPICLK source transition from SPISI."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent;base=H/'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V615_SPI_BOTTOM_CLEAR2.kicad_pcb';out=H/'PHASE24_RTL9210B_SUPPORT_COALLOCATED_V618_SPICLK_SOURCE_SEP.kicad_pcb'
