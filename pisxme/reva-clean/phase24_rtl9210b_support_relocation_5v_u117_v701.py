"""V701: U1.17 RTL_5V two-via jog around the 3V3/1V1 barrier."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SUPPORT_RELOCATION_5V_OVERPASS_FINAL_V699.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_SUPPORT_RELOCATION_5V_U117_V701.kicad_pcb'
...
tr(b,n,F,(101.20,73.95),(101.20,76.20));tr(b,n,F,(101.20,76.20),(102.20,76.20));vi(b,n,(102.20,76.20))
