"""V692: move the U1.52 transition left and use the open B.Cu channel."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SUPPORT_RELOCATION_3V3_U139_JOG_V687.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_SUPPORT_RELOCATION_C2_GND_U152_V692.kicad_pcb'
...
t(b,n3,F,(94.05,66.8),(91.5,66.8));t(b,n3,F,(91.5,66.8),(91.5,65.0));v(b,n3,(91.5,65.0));t(b,n3,B,(91.5,65.0),(91.5,55.0))
