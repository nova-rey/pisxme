"""V706: SPICS upper F.Cu dogleg after rejecting the V703/V705 escapes."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_SUPPORT_RELOCATION_5V_U117_V702.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_SUPPORT_RELOCATION_SPI_SPICS_V706.kicad_pcb'
F=pcbnew.F_Cu
...
path=[(101.95,70.8),(102.5,69.5),(105.5,69.5),(105.5,51.0),(106.5,51.0),(106.5,57.0),(125.8,57.0),(125.8,58.0)]
