"""V288: short SPICLK U1 dogbone before the RTL_3V3 handoff."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_SUPPORT_ROUTE_SPISO3_V286.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_SUPPORT_ROUTE_SPICLK_V288.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(100.8,58.05),(100.8,57.5));via(b,n,(100.8,57.5));tr(b,n,B,(100.8,57.5),(103.0,57.5));tr(b,n,B,(103.0,57.5),(103.0,48.0));tr(b,n,B,(103.0,48.0),(89.3,48.0));tr(b,n,B,(89.3,48.0),(89.3,68.0));via(b,n,(89.3,68.0));tr(b,n,F,(89.3,68.0),(89.3,70.0))
