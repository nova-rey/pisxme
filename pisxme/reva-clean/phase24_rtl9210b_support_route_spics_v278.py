"""V278: offset SPICS around the retained B.Cu REFCLK corridor."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_SUPPORT_ROUTE_RAILS_V274.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_SUPPORT_ROUTE_SPICS_V278.kicad_pcb"
...
def main():
    ...
    tr(board, net, B, (98.8, 57.0), (96.5, 57.0))
    tr(board, net, B, (96.5, 57.0), (96.5, 72.0))
    tr(board, net, B, (96.5, 72.0), (83.3, 72.0))
