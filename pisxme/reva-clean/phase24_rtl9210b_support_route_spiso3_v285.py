"""V285: SPISO3 changes to B.Cu before the crystal-support pad field."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_SUPPORT_ROUTE_SPISO_V282.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_SUPPORT_ROUTE_SPISO3_V285.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(99.6,58.05),(99.6,56.0));via(b,n,(99.6,56.0));tr(b,n,B,(99.6,56.0),(99.6,49.0));tr(b,n,B,(99.6,49.0),(90.5,49.0));tr(b,n,B,(90.5,49.0),(90.5,68.0));via(b,n,(90.5,68.0));tr(b,n,F,(90.5,68.0),(90.5,70.0))
