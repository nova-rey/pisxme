"""V280: offset SPISO around the retained SPICS lane and crystal field."""
from pathlib import Path
import pcbnew

HERE = Path(__file__).resolve().parent
BASE = HERE / "PHASE24_RTL9210B_SUPPORT_ROUTE_SPICS_V278.kicad_pcb"
OUT = HERE / "PHASE24_RTL9210B_SUPPORT_ROUTE_SPISO_V280.kicad_pcb"
...
def main():
    ...
    via(board, net, (96.0, 56.0)); tr(board, net, F, (99.2, 58.05), (96.0, 56.0))
    tr(board, net, B, (96.0, 56.0), (96.0, 78.0))
    tr(board, net, B, (96.0, 78.0), (84.5, 78.0))
    tr(board, net, B, (84.5, 78.0), (84.5, 68.0)); via(board, net, (84.5, 68.0))
