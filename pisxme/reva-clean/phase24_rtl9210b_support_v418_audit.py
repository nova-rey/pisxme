"""Native connectivity audit for V418, including PEDET."""
import pcbnew
from pathlib import Path
PCB=Path(__file__).resolve().parent/'PHASE24_RTL9210B_PEDET_NATIVE_ESCAPE_V418.kicad_pcb'
GROUPS={
...
def main():
 ...
 print('PASS V418 native lane/support/control/PEDET connectivity; seven trace-removal negative controls PASS')
