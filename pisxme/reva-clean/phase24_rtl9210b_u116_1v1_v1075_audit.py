"""Saved-board native RTL_1V1 audit for V1075."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; PCB=H/'PHASE24_RTL9210B_U116_1V1_V1075.kicad_pcb'; ENDS=[('U1','16'),('U1','36'),('U1','40'),('U1','50'),('C4','1')]
...
b.BuildConnectivity(); ts=[x for x in b.GetConnectivity().GetConnectedItems(p[('U1','16')]) if type(x).__name__=='PCB_TRACK' and x.GetNetname()=='RTL_1V1']; assert ts
for c in ts:
 ...
 if ('C4','1') not in reach(t,q[('U1','16')]): print('RTL_1V1 U1.16 source-trace negative control PASS'); break
else: raise AssertionError('RTL_1V1 U1.16 source-trace removal remained connected')
