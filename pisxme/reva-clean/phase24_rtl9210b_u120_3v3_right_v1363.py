"""V1363: direct U1.20 dogbone to a B.Cu RTL_3V3 branch."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_U152_3V3_ESCAPE_V1359.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_U120_3V3_RIGHT_V1363.kicad_pcb'
...
tr(b,n,F,(101.95,72.4),(103.0,72.4)); via(b,n,(103.0,72.4)); tr(b,n,B,(103.0,72.4),(103.0,66.8)); via(b,n,(103.0,66.8))
