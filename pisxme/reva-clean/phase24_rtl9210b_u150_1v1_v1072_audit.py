"""Saved-board native RTL_1V1 audit for V1072."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; PCB=H/'PHASE24_RTL9210B_U150_1V1_V1072.kicad_pcb'; ENDS=[('U1','36'),('U1','40'),('U1','50'),('C4','1')]
...
b.BuildConnectivity(); ts=[x for x in b.GetConnectivity().GetConnectedItems(p[('U1','50')]) if type(x).__name__=='PCB_TRACK' and x.GetNetname()=='RTL_1V1']; assert ts
for c in ts:
 ...
 if ('C4','1') not in reach(t,q[('U1','50')]): print('RTL_1V1 U1.50 source-trace negative control PASS'); break
else: raise AssertionError('RTL_1V1 source-trace removal remained connected')
