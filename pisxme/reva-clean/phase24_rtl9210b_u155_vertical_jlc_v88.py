"""V88: test a direct JLC-rule U1.55 bottom-edge RTL_1V1 escape."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_QFN_ESCAPE_JLC_V86.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_U155_VERTICAL_JLC_V88.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(96.0,73.95),(96.0,75.2));vi(b,n,(96.0,75.2));tr(b,n,B,(96.0,75.2),(96.0,69.5))
