"""V90: route U1.60 above the retained XTAL_IN B.Cu diagonal."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_QFN_ESCAPE_JLC_V86.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_U160_ABOVE_XTAL_JLC_V90.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(98.0,73.95),(98.0,74.4));vi(b,n,(98.0,74.4));tr(b,n,B,(98.0,74.4),(108.5,74.4));tr(b,n,B,(108.5,74.4),(108.5,69.5))
