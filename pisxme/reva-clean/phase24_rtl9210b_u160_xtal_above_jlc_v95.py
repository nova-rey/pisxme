"""V95: U1.60 dogleg to a B.Cu corridor unambiguously above XTAL_IN."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_QFN_ESCAPE_JLC_V86.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_U160_XTAL_ABOVE_JLC_V95.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(98.0,73.95),(98.0,74.8));tr(b,n,F,(98.0,74.8),(103.0,74.8));tr(b,n,F,(103.0,74.8),(103.0,73.8));vi(b,n,(103.0,73.8));tr(b,n,B,(103.0,73.8),(107.0,73.8));tr(b,n,B,(107.0,73.8),(107.0,69.5))
