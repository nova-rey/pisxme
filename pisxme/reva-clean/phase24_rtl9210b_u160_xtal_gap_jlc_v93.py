"""V93: U1.60 transition before the XTAL_IN via, then drop at x107.0."""
from pathlib import Path
import pcbnew
HERE=Path(__file__).resolve().parent
BASE=HERE/'PHASE24_RTL9210B_QFN_ESCAPE_JLC_V86.kicad_pcb'
OUT=HERE/'PHASE24_RTL9210B_U160_XTAL_GAP_JLC_V93.kicad_pcb'
...
def main():
 ...
 tr(b,n,F,(98.0,73.95),(98.0,74.6));tr(b,n,F,(98.0,74.6),(103.0,74.6));vi(b,n,(103.0,74.6));tr(b,n,B,(103.0,74.6),(107.0,74.6));tr(b,n,B,(107.0,74.6),(107.0,69.5))
