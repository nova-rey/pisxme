"""V1298 native SPI endpoint and saved-board negative-control audit."""
from pathlib import Path
import pcbnew
P=Path(__file__).resolve().parent/'PHASE24_RTL9210B_V735_SPI_LAYER_SWAP_V1298.kicad_pcb'
...
print('PASS V1298 native rotated SPI layer-swap endpoints and saved-board negative controls')
