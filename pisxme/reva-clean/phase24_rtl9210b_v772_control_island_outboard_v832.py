"""V832: disposable far-outboard control-island placement probe."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V760_SUPPORT_SIGNALS_GROUND_V772.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_V772_CONTROL_ISLAND_OUTBOARD_V832.kicad_pcb'
b=pcbnew.LoadBoard(str(BASE))
for ref,target in {'R2':(120,90),'R3':(120,95)}.items():
