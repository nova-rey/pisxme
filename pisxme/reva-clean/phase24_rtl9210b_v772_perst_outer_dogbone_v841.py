"""V841: PERST_N lower dogbone into the clear outer transition."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V772_CONTROL_INBOARD_MONOTONIC_V837.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_V772_PERST_OUTER_DOGBONE_V841.kicad_pcb'
...
T(b,n,F,[(101.95,68.0),(103,69.5),(108.5,64.5)]); V(b,n,(108.5,64.5)); T(b,n,B,[(108.5,64.5),(108.5,84),(135,84),(135,70.275)]); V(b,n,(135,70.275)); T(b,n,F,[(135,70.275),(136,70.275)])
