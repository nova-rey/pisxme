"""V839: offset PERST_N upward before the perimeter transition."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V772_CONTROL_INBOARD_MONOTONIC_V837.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_V772_PERST_SOURCE_OFFSET_V839.kicad_pcb'
...
T(b,n,F,[(101.95,68.0),(102.8,67.2),(103.5,66.5)]); V(b,n,(103.5,66.5)); T(b,n,B,[(103.5,66.5),(103.5,84),(135,84),(135,70.275)]); V(b,n,(135,70.275)); T(b,n,F,[(135,70.275),(136,70.275)])
