"""V857: lift the PERST_N via clear of the parallel CLKREQ_N corridor."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V772_CONTROL_INBOARD_MONOTONIC_V837.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_V772_PERST_STRAIGHT_RIGHT_V857.kicad_pcb'
...
tr(b,n,F,[(101.95,68.0),(107.0,68.0),(107.0,67.0),(108.5,67.0)])
via(b,n,108.5,67.0)
tr(b,n,B,[(108.5,67.0),(108.5,84.0),(135.0,84.0),(135.0,70.275)])
