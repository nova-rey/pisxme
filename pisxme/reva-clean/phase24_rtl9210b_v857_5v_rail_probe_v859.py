"""V859: narrow/outboard RTL_5V escape from the V857 rail probe."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V772_PERST_STRAIGHT_RIGHT_V857.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_V857_5V_RAIL_PROBE_V859.kicad_pcb'
...
tr(b,n,F,[(101.95,66.8),(107.0,66.8)]); via(b,n,107.0,66.8)
via(b,n,126.4,50.0); tr(b,n,L,[(107.0,66.8),(126.4,50.0)])
