"""Saved-board U2.8-to-C3 RTL_3V3 audit and negative control."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent; PCB=H/'PHASE24_RTL9210B_V862_3V3_U28_C3_V869.kicad_pcb'
ENDS=(('U2','8'),('C3','1'))
...
b=pcbnew.LoadBoard(str(PCB)); p=pads(b); assert all(e in p and p[e].GetNetname()=='RTL_3V3' for e in ENDS); assert all(e in (reach(b,p[ENDS[0]])|{ENDS[0]}) for e in ENDS); print('RTL_3V3 U2.8/C3.1: PASS')
...
for item in items:
 ...
 if ENDS[1] not in (reach(t,q[ENDS[0]])|{ENDS[0]}): print('RTL_3V3 U2.8/C3.1 negative control: PASS'); break
