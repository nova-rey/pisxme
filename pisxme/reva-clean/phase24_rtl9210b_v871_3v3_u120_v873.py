"""V873: stepped U1.20 RTL_3V3 escape above SPI departure endpoints."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V870_3V3_U139_V871.kicad_pcb'
OUT=H/'PHASE24_RTL9210B_V871_3V3_U120_V873.kicad_pcb'
...
tr(b,n,F,(100.4,66.05),(100.4,65.0),(102.5,65.0));via(b,n,102.5,65.0)
tr(b,n,L,(102.5,65.0),(107.3,71.6))
