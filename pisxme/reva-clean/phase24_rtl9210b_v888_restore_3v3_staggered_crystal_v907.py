"""V907: connect relocated 3V3 on B.Cu and separate the XTAL_OUT transition."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V885_SUPPORT_GND_RETURN_V888.kicad_pcb';OUT=H/'PHASE24_RTL9210B_V888_RESTORE_3V3_STAGGERED_CRYSTAL_V907.kicad_pcb'
...
tr(b,p,[(94.8,73.95),(94.8,78.0),(93.0,78.0)],F);via(b,p,93.0,78.0);tr(b,p,[(93.0,78.0),(107.3,78.0),(107.3,77.6)],B)
