"""V898: separate XTAL_IN transition from the XTAL_OUT dogbone."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V885_SUPPORT_GND_RETURN_V888.kicad_pcb';OUT=H/'PHASE24_RTL9210B_V888_RESTORE_3V3_XTALIN_BCU_V898.kicad_pcb'
...
n=b.FindNet('XTAL_IN');tr(b,n,[(95.2,73.95),(95.2,76.0),(97.5,76.0),(97.5,78.0)],F);via(b,n,97.5,78.0)
tr(b,n,[(97.5,78.0),(97.5,55.0),(86.0,55.0)],B);via(b,n,86.0,55.0);tr(b,n,[(86.0,55.0),(88.0,59.0),(88.0,62.0)],F)
