"""V900: separated F.Cu source lanes and east-shifted XTAL_IN B.Cu spine."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_V885_SUPPORT_GND_RETURN_V888.kicad_pcb';OUT=H/'PHASE24_RTL9210B_V888_RESTORE_3V3_XTALIN_BCU_V900.kicad_pcb'
...
n=b.FindNet('XTAL_IN');tr(b,n,[(95.2,73.95),(95.2,75.2),(102.5,75.2),(102.5,76.0)],F);via(b,n,102.5,76.0)
tr(b,n,[(102.5,76.0),(102.5,55.0),(86.0,55.0)],B);via(b,n,86.0,55.0);tr(b,n,[(86.0,55.0),(88.0,59.0),(88.0,62.0)],F)
