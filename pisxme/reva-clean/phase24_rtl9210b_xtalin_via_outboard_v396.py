"""V396: move the standard XTAL_IN transition beyond the exposed-pad edge."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
src=H/'PHASE24_RTL9210B_XTALIN_ESCAPE_V392.kicad_pcb'; out=H/'PHASE24_RTL9210B_XTALIN_VIA_REPOSITIONED_V397.kicad_pcb'
...
n=b.FindNet('XTAL_IN'); seg(b,n,F,(109.95,64.8),(107.0,64.8)); seg(b,n,F,(107.0,64.8),(107.0,64.95)); via(b,n,(107.0,64.95)); seg(b,n,B,(107.0,64.95),(107.0,44.0)); seg(b,n,B,(107.0,44.0),(115.3,44.0)); via(b,n,(115.3,44.0)); seg(b,n,F,(115.3,44.0),(115.3,49.0)); seg(b,n,F,(115.3,49.0),(114.3,49.0)); via(b,n,(114.3,49.0)); seg(b,n,B,(114.3,49.0),(114.3,48.0)); seg(b,n,B,(114.3,48.0),(120.1,48.0)); via(b,n,(120.1,48.0))
