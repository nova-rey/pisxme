"""V1143: XTAL_OUT corridor routed around the native GND return triangle."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_RTL9210B_QFN_GND_ATTACH_V1123.kicad_pcb'; OUT=H/'PHASE24_RTL9210B_XTALOUT_GND_TRIANGLE_AVOID_V1143.kicad_pcb'
...
tr(b,n,F,[u,(u[0]-.65,u[1]),(92.5,67.6)]);via(b,n,(92.5,67.6))
# Stay below and left of both native GND diagonals on B.Cu.
tr(b,n,B,[(92.5,67.6),(88.0,68.0),(88.0,58.0)]);via(b,n,(88.0,58.0))
