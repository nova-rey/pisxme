#!/usr/bin/env python3
"""V13: V12 geometry with 0.10-mm local disposable escape tracks."""
from pathlib import Path
import pcbnew
ROOT=Path(__file__).resolve().parent
BASE=ROOT/'PHASE24_PATHA_M2_LANE0_LAUNCH_ISOLATED_V1.kicad_pcb'
OUT=ROOT/'PHASE24_PATHA_M2_LANE0_LAUNCH_ISOLATED_V13.kicad_pcb'
F,B=pcbnew.F_Cu,pcbnew.B_Cu; W=pcbnew.FromMM(.10)
...
def main():
    ...
    specs=[
      ...
      ('M2_SATA_A_N_PCIE_TXN0','3','47',(218,153.5),'B',[(173.5,147.6),(173.5,136),(192,136),(210,136),(218,153.5)],156.0),
      ('M2_SATA_B_P_PCIE_RXN0','6','41',(214,153.5),'F',[(169,148.8),(169,154),(190,154),(206,154),(214,153.5)],158.5),
      ('M2_SATA_B_N_PCIE_RXP0','7','43',(216,153.5),'B',[(171.5,151),(171.5,165),(206,165),(206,168),(213,168),(216,153.5)],158.5),
    ]
    for name,up,jp,target,layer,pts,depart_y in specs:
        ...
        via(b,n,target); path(b,n,[dst,(dst[0],depart_y),target],F)
