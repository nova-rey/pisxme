#!/usr/bin/env python3
"""V7: retain V5, move only RXP to a lower B.Cu corridor around M1."""
from pathlib import Path
import pcbnew
ROOT=Path(__file__).resolve().parent
BASE=ROOT/'PHASE24_PATHA_M2_LANE0_LAUNCH_ISOLATED_V1.kicad_pcb'
OUT=ROOT/'PHASE24_PATHA_M2_LANE0_LAUNCH_ISOLATED_V7.kicad_pcb'
...
def main():
    ...
    specs=[
      ...
      ('M2_SATA_B_N_PCIE_RXP0','7','43',(216,153.5),'B',[(171.5,149.2),(171.5,165),(206,165),(208,165),(216,153.5)]),
    ]
