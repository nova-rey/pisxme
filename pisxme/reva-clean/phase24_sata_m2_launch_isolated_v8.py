#!/usr/bin/env python3
"""V8: V7 RXP B.Cu corridor routed below and then outboard of M1."""
from pathlib import Path
import pcbnew
ROOT=Path(__file__).resolve().parent
BASE=ROOT/'PHASE24_PATHA_M2_LANE0_LAUNCH_ISOLATED_V1.kicad_pcb'
OUT=ROOT/'PHASE24_PATHA_M2_LANE0_LAUNCH_ISOLATED_V8.kicad_pcb'
...
def main():
    ...
    specs=[
      ...
      ('M2_SATA_B_P_PCIE_RXN0','6','41',(214,153.5),'F',[(175,148.8),(175,154),(190,154),(206,154),(214,153.5)]),
      ('M2_SATA_B_N_PCIE_RXP0','7','43',(216,153.5),'B',[(171.5,149.2),(171.5,165),(206,165),(206,168),(213,168),(216,153.5)]),
    ]
