"""V73: BRIDGE_R1RTN left escape and B.Cu transfer."""
from pathlib import Path
import pcbnew
H=Path(__file__).resolve().parent
BASE=H/'PHASE24_STORAGE_CM5_USB4_MONOTONIC_V54_STORAGE_GND_SOLID.kicad_pcb'
OUT=H/'PHASE24_STORAGE_CM5_USB4_MONOTONIC_V73_BRIDGE_R1RTN_LEFT_BYPASS.kicad_pcb'
...
seg((92.2,123.4),(90.5,123.4),F); via((90.5,123.4)); seg((90.5,123.4),(90.5,121.0),B); seg((90.5,121.0),(138.0,121.0),B); via((138.0,121.0)); seg((138.0,121.0),(138.0,122.0),F)
