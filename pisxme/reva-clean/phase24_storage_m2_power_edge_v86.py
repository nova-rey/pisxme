"""V86: move the rightmost through-via beyond the second Ethernet CT support."""
from pathlib import Path
import pcbnew
R=Path(__file__).resolve().parent
BASE=R/'PHASE24_STORAGE_CM5_USB4_MONOTONIC_V79_M2_POWER_OWNER.kicad_pcb'
OUT=R/'PHASE24_STORAGE_M2_POWER_EDGE_V86.kicad_pcb'
...
for g in [(211.0,211.5),(213.5,214.0,214.5,215.0),(228.0,228.5,229.0)]:
 ...
 qx=g[-1]; endx=233.0 if qx==229.0 else qx
