"""V87: V86 with the rightmost drop beyond C51/C52 support."""
from pathlib import Path
import pcbnew
R=Path(__file__).resolve().parent; BASE=R/'PHASE24_STORAGE_CM5_USB4_MONOTONIC_V79_M2_POWER_OWNER.kicad_pcb'; OUT=R/'PHASE24_STORAGE_M2_POWER_EDGE_V87.kicad_pcb'
...
for g in [(211.0,211.5),(213.5,214.0,214.5,215.0),(228.0,228.5,229.0)]:
 ...
 tr(pcbnew.F_Cu,[(qx,167.275),(endx,167.275),(endx,181)]); via(endx,181); tr(pcbnew.In1_Cu,[(endx,181),(186,182)],.35)
