"""V88: local F.Cu source pickup zone plus outboard In1 power trunk."""
from pathlib import Path
import pcbnew
R=Path(__file__).resolve().parent
BASE=R/'PHASE24_STORAGE_CM5_USB4_MONOTONIC_V79_M2_POWER_OWNER.kicad_pcb'
OUT=R/'PHASE24_STORAGE_M2_POWER_LOCAL_ZONE_V88.kicad_pcb'
...
z.AddPolygon(poly); b.Add(z); tr(pcbnew.In1_Cu,[(186,135),(186,182)],.35)
