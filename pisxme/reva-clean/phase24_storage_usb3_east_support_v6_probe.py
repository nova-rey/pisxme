...
# U11 bottom row escapes outward; only these four short segments use 0.10 mm.
tr(b,'USB_TXP1',(141.4,138.6),(141.4,139.1),w=.10); tr(b,'USB_TXP1',(141.4,139.1),(142.2,140.0),w=.10); tr(b,'USB_TXP1',(142.2,140.0),(145.5,141.5))
tr(b,'USB_TXN1',(141.0,138.6),(141.0,139.1),w=.10); tr(b,'USB_TXN1',(141.0,139.1),(140.2,140.8),w=.10); tr(b,'USB_TXN1',(140.2,140.8),(145.5,143.5))
...
tr(b,'USB_RXP1',(139.4,138.6),(139.4,139.1),w=.10); tr(b,'USB_RXP1',(139.4,139.1),(137.0,140.5),w=.10); via(b,'USB_RXP1',(137.0,140.5)); tr(b,'USB_RXP1',(137.0,140.5),(151.0,147.0),pcbnew.B_Cu); tr(b,'USB_RXP1',(151.0,147.0),(171.5,147.0),pcbnew.B_Cu); tr(b,'USB_RXP1',(171.5,147.0),(171.5,137.2),pcbnew.B_Cu); via(b,'USB_RXP1',(171.5,137.2)); tr(b,'USB_RXP1',(171.5,137.2),(166.5,137.8))
tr(b,'USB_RXN1',(139.0,138.6),(139.0,139.1),w=.10); tr(b,'USB_RXN1',(139.0,139.1),(135.5,141.2),w=.10); via(b,'USB_RXN1',(135.5,141.2)); tr(b,'USB_RXN1',(135.5,141.2),(151.0,148.0),pcbnew.B_Cu); tr(b,'USB_RXN1',(151.0,148.0),(172.5,148.0),pcbnew.B_Cu); tr(b,'USB_RXN1',(172.5,148.0),(172.5,138.8),pcbnew.B_Cu); via(b,'USB_RXN1',(172.5,138.8)); tr(b,'USB_RXN1',(172.5,138.8),(166.5,138.2))
