"""V64: escape U11 XOUT below the complete clock-pad row."""
from pathlib import Path
import pcbnew

H = Path(__file__).resolve().parent
BASE = H / "PHASE24_STORAGE_CM5_USB4_MONOTONIC_V54_STORAGE_GND_SOLID.kicad_pcb"
OUT = H / "PHASE24_STORAGE_CM5_USB4_MONOTONIC_V64_XOUT_BELOW_U11.kicad_pcb"
...
def via(point):
    v = pcbnew.PCB_VIA(b)
    v.SetPosition(P(*point)); v.SetWidth(pcbnew.FromMM(0.5))
...
route([(137.8, 131.4), (137.8, 133.0), (135.0, 133.0), (135.0, 129.2)], F)
via((135.0, 129.2))
route([(135.0, 129.2), (132.0, 129.2), (146.5, 112.0)], B)
via((146.5, 112.0))
route([(146.5, 112.0), (148.9, 115.85)], F)
