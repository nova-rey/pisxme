...
OUT=R/'PHASE24_SELECTED_MACRO_ETH_SUPPORT_V15_LOCAL.kicad_pcb'
ORACLE_J2=(77.5,53.0)
...
b=pcbnew.LoadBoard(str(BASE)); j2=b.FindFootprintByReference('J2'); local=xy(j2.GetPosition()); dx,dy=local[0]-ORACLE_J2[0],local[1]-ORACLE_J2[1]
