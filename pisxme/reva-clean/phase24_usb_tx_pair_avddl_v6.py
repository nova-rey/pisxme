"""V6: order-preserving TX pair with AVDDL transition moved south."""
...
def clear(name):
 ...
 return n
p=clear('USB_TXP1'); tr(p,xy('U11',21),(141.4,144),F); tr(p,(141.4,144),(146.5,144),F); tr(p,(146.5,144),xy('C86',1),F)
n=clear('USB_TXN1'); tr(n,xy('U11',22),(141.0,146),F); tr(n,(141.0,146),(146.5,146),F); tr(n,(146.5,146),xy('C87',1),F)
a=clear('JMS_AVDDL'); tr(a,xy('U11',20),(141.8,141.8),F); via(a,(141.8,141.8)); tr(a,(141.8,141.8),(154.5,142),B); via(a,(154.5,142)); tr(a,(154.5,142),(154.5,147),F); tr(a,(154.5,147),xy('C83',1),F)
b.BuildListOfNets(); out=R/'PHASE24_STORAGE_J8_V5_USB_TX_PAIR_AVDDL_V6.kicad_pcb'; b.Save(str(out)); print(out)
