...
PORTS = {
    "CORE_CM5": ("CM5_PER0_P", "CM5_PER0_N", "CM5_PET0_P", "CM5_PET0_N", "CM5_REFCLK_P", "CM5_REFCLK_N", "CM5_PERST", "CM5_USB3", "CM5_STORAGE_USB2_DP", "CM5_STORAGE_USB2_DM", "CM5_GBE", "SERVICE_USB2_DP", "SERVICE_USB2_DM", "CM5_POWER", "CM5_5V"),
    ...
    "REGULATORS": ("12V_PROTECTED", "CM5_5V", "STORAGE_3V3", "BRIDGE_1V1_3V3", "BRIDGE_3V3", "BRIDGE_1V1"),
    "ETHERNET": ("CM5_GBE", "GBE_LED", "GBE_SHIELD", "ETH_POWER"),
    "STORAGE": ("CM5_USB3", "BRIDGE_SATA", "M2_SATA", "M2_3V3", "BRIDGE_CFG", "BRIDGE_3V3", "BRIDGE_1V1"),
    "SERVICE": ("SERVICE_USB2_DP", "SERVICE_USB2_DM", "SERVICE_VBUS_SENSE", "SERVICE_RD", "SERVICE_GND"),
...
PCIE_DIRECT_ROOT_LINKS = (
    ...
    ((35, 74), (105, 147)), # service USB2 D+
    ((35, 77), (105, 150)), # service USB2 D-
)
