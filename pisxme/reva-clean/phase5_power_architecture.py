...
def main():
    ...
    edit('REGULATORS.kicad_sch', (('TPSM63606RDLR_5V', ('IN', 'OUT', 'GND', 'PG')), ('TPSM63606RDLR_3V3', ('IN', 'OUT', 'GND', 'EN')), ('TPSM63606RDLR_1V1', ('IN', 'OUT', 'GND', 'EN'))), (('TPSM63606RDLR_5V', 'U_CM5_5V', 'TPSM63606RDLR', ('12V_PROTECTED', 'CM5_5V', 'POWER_GND', 'POWER_PG_FAULT'), 0xd5000000000000000000000000000000), ('TPSM63606RDLR_3V3', 'U_BRIDGE_3V3', 'TPSM63606RDLR', ('12V_PROTECTED', 'BRIDGE_3V3', 'POWER_GND', 'BRIDGE_ENABLE'), 0xd6000000000000000000000000000000), ('TPSM63606RDLR_1V1', 'U_BRIDGE_1V1', 'TPSM63606RDLR', ('12V_PROTECTED', 'BRIDGE_1V1', 'POWER_GND', 'BRIDGE_ENABLE'), 0xd7000000000000000000000000000000)))
