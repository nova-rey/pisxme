...
def main() -> None:
    ...
    try:
        ...
        # kicad-cli's current XML exporter promotes the root CM5_5V net while
        # retaining child-local hierarchical names for the regulator rails.
        for ref, net_name in (("U3", "CM5_5V"),
                              ("U4", "BRIDGE_3V3"),
                              ("U5", "BRIDGE_1V1")):
        ...
        cm5_nodes = {(n.attrib.get("ref"), n.attrib.get("pin"))
                     for n in named["CM5_5V"].findall("node")}
