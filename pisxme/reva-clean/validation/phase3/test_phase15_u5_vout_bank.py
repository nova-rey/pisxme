...
def main():
    ...
    assert report.count("[unconnected_items]") == 237
    probe = r'''
import pcbnew
...
assert len(vias) == 69
assert sum(x.GetNetname() == out for x in vias) == 18
...
'''
    ...
    print("Phase 15 U5 VOUT-bank regression: PASS; 69 vias; 237 unrouted items")
